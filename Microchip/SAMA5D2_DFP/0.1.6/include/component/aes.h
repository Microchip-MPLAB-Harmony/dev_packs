...
#define _SAMA5D2_AES_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Advanced Encryption Standard
 *  @{
 */
/* ========================================================================== */
...
#define REV_AES ZB                     /**< (AES) Module revision */
...
#define AES_MR_CKEY_Pos                     20                                             /**< (AES_MR) Key Position */
...
typedef union { 
  struct {
    ...
    uint32_t EOPAD:1;                   /**< bit:     17  End of Padding Interrupt Enable          */
    uint32_t PLENERR:1;                 /**< bit:     18  Padding Length Error Interrupt Enable    */
...
#define AES_IER_EOPAD_Pos                   17                                             /**< (AES_IER) End of Padding Interrupt Enable Position */
#define AES_IER_EOPAD_Msk                   (_U_(0x1) << AES_IER_EOPAD_Pos)                /**< (AES_IER) End of Padding Interrupt Enable Mask */
#define AES_IER_EOPAD                       AES_IER_EOPAD_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_IER_EOPAD_Msk instead */
#define AES_IER_PLENERR_Pos                 18                                             /**< (AES_IER) Padding Length Error Interrupt Enable Position */
#define AES_IER_PLENERR_Msk                 (_U_(0x1) << AES_IER_PLENERR_Pos)              /**< (AES_IER) Padding Length Error Interrupt Enable Mask */
#define AES_IER_PLENERR                     AES_IER_PLENERR_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_IER_PLENERR_Msk instead */
#define AES_IER_MASK                        _U_(0x70101)                                   /**< \deprecated (AES_IER) Register MASK  (Use AES_IER_Msk instead)  */
#define AES_IER_Msk                         _U_(0x70101)                                   /**< (AES_IER) Register Mask  */
...
typedef union { 
  struct {
    ...
    uint32_t EOPAD:1;                   /**< bit:     17  End of Padding Interrupt Disable         */
    uint32_t PLENERR:1;                 /**< bit:     18  Padding Length Error Interrupt Disable   */
    uint32_t :13;                       /**< bit: 19..31  Reserved */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} AES_IDR_Type;
...
#define AES_IDR_EOPAD_Pos                   17                                             /**< (AES_IDR) End of Padding Interrupt Disable Position */
#define AES_IDR_EOPAD_Msk                   (_U_(0x1) << AES_IDR_EOPAD_Pos)                /**< (AES_IDR) End of Padding Interrupt Disable Mask */
#define AES_IDR_EOPAD                       AES_IDR_EOPAD_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_IDR_EOPAD_Msk instead */
#define AES_IDR_PLENERR_Pos                 18                                             /**< (AES_IDR) Padding Length Error Interrupt Disable Position */
#define AES_IDR_PLENERR_Msk                 (_U_(0x1) << AES_IDR_PLENERR_Pos)              /**< (AES_IDR) Padding Length Error Interrupt Disable Mask */
#define AES_IDR_PLENERR                     AES_IDR_PLENERR_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_IDR_PLENERR_Msk instead */
#define AES_IDR_MASK                        _U_(0x70101)                                   /**< \deprecated (AES_IDR) Register MASK  (Use AES_IDR_Msk instead)  */
#define AES_IDR_Msk                         _U_(0x70101)                                   /**< (AES_IDR) Register Mask  */
...
typedef union { 
  struct {
    ...
    uint32_t EOPAD:1;                   /**< bit:     17  End of Padding Interrupt Mask            */
    uint32_t PLENERR:1;                 /**< bit:     18  Padding Length Error Interrupt Mask      */
    uint32_t :13;                       /**< bit: 19..31  Reserved */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} AES_IMR_Type;
...
#define AES_IMR_EOPAD_Pos                   17                                             /**< (AES_IMR) End of Padding Interrupt Mask Position */
#define AES_IMR_EOPAD_Msk                   (_U_(0x1) << AES_IMR_EOPAD_Pos)                /**< (AES_IMR) End of Padding Interrupt Mask Mask */
#define AES_IMR_EOPAD                       AES_IMR_EOPAD_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_IMR_EOPAD_Msk instead */
#define AES_IMR_PLENERR_Pos                 18                                             /**< (AES_IMR) Padding Length Error Interrupt Mask Position */
#define AES_IMR_PLENERR_Msk                 (_U_(0x1) << AES_IMR_PLENERR_Pos)              /**< (AES_IMR) Padding Length Error Interrupt Mask Mask */
#define AES_IMR_PLENERR                     AES_IMR_PLENERR_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_IMR_PLENERR_Msk instead */
#define AES_IMR_MASK                        _U_(0x70101)                                   /**< \deprecated (AES_IMR) Register MASK  (Use AES_IMR_Msk instead)  */
#define AES_IMR_Msk                         _U_(0x70101)                                   /**< (AES_IMR) Register Mask  */
...
typedef union { 
  struct {
    ...
    uint32_t EOPAD:1;                   /**< bit:     17  End of Padding                           */
    uint32_t PLENERR:1;                 /**< bit:     18  Padding Length Error                     */
    uint32_t :13;                       /**< bit: 19..31  Reserved */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} AES_ISR_Type;
...
#define AES_ISR_EOPAD_Pos                   17                                             /**< (AES_ISR) End of Padding Position */
#define AES_ISR_EOPAD_Msk                   (_U_(0x1) << AES_ISR_EOPAD_Pos)                /**< (AES_ISR) End of Padding Mask */
#define AES_ISR_EOPAD                       AES_ISR_EOPAD_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_ISR_EOPAD_Msk instead */
#define AES_ISR_PLENERR_Pos                 18                                             /**< (AES_ISR) Padding Length Error Position */
#define AES_ISR_PLENERR_Msk                 (_U_(0x1) << AES_ISR_PLENERR_Pos)              /**< (AES_ISR) Padding Length Error Mask */
#define AES_ISR_PLENERR                     AES_ISR_PLENERR_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_ISR_PLENERR_Msk instead */
#define AES_ISR_MASK                        _U_(0x7F101)                                   /**< \deprecated (AES_ISR) Register MASK  (Use AES_ISR_Msk instead)  */
#define AES_ISR_Msk                         _U_(0x7F101)                                   /**< (AES_ISR) Register Mask  */
...
typedef union { 
  struct {
    uint32_t APEN:1;                    /**< bit:      0  Auto Padding Enable                      */
    uint32_t APM:1;                     /**< bit:      1  Auto Padding Mode                        */
    uint32_t :2;                        /**< bit:   2..3  Reserved */
    uint32_t PLIPEN:1;                  /**< bit:      4  Protocol Layer Improved Performance Enable */
    uint32_t PLIPD:1;                   /**< bit:      5  Protocol Layer Improved Performance Decipher */
    uint32_t :2;                        /**< bit:   6..7  Reserved */
    uint32_t PADLEN:8;                  /**< bit:  8..15  Auto Padding Length                      */
    uint32_t NHEAD:8;                   /**< bit: 16..23  IPSEC Next Header                        */
    uint32_t :8;                        /**< bit: 24..31  Reserved */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} AES_EMR_Type;
...
#define AES_EMR_OFFSET                      (0xB0)                                        /**<  (AES_EMR) Extended Mode Register  Offset */

#define AES_EMR_APEN_Pos                    0                                              /**< (AES_EMR) Auto Padding Enable Position */
#define AES_EMR_APEN_Msk                    (_U_(0x1) << AES_EMR_APEN_Pos)                 /**< (AES_EMR) Auto Padding Enable Mask */
#define AES_EMR_APEN                        AES_EMR_APEN_Msk                               /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_EMR_APEN_Msk instead */
#define AES_EMR_APM_Pos                     1                                              /**< (AES_EMR) Auto Padding Mode Position */
#define AES_EMR_APM_Msk                     (_U_(0x1) << AES_EMR_APM_Pos)                  /**< (AES_EMR) Auto Padding Mode Mask */
#define AES_EMR_APM                         AES_EMR_APM_Msk                                /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_EMR_APM_Msk instead */
#define AES_EMR_PLIPEN_Pos                  4                                              /**< (AES_EMR) Protocol Layer Improved Performance Enable Position */
#define AES_EMR_PLIPEN_Msk                  (_U_(0x1) << AES_EMR_PLIPEN_Pos)               /**< (AES_EMR) Protocol Layer Improved Performance Enable Mask */
#define AES_EMR_PLIPEN                      AES_EMR_PLIPEN_Msk                             /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_EMR_PLIPEN_Msk instead */
#define AES_EMR_PLIPD_Pos                   5                                              /**< (AES_EMR) Protocol Layer Improved Performance Decipher Position */
#define AES_EMR_PLIPD_Msk                   (_U_(0x1) << AES_EMR_PLIPD_Pos)                /**< (AES_EMR) Protocol Layer Improved Performance Decipher Mask */
#define AES_EMR_PLIPD                       AES_EMR_PLIPD_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use AES_EMR_PLIPD_Msk instead */
#define AES_EMR_PADLEN_Pos                  8                                              /**< (AES_EMR) Auto Padding Length Position */
...
#define AES_EMR_NHEAD_Pos                   16                                             /**< (AES_EMR) IPSEC Next Header Position */
...
#define AES_EMR_MASK                        _U_(0xFFFF33)                                  /**< \deprecated (AES_EMR) Register MASK  (Use AES_EMR_Msk instead)  */
#define AES_EMR_Msk                         _U_(0xFFFF33)                                  /**< (AES_EMR) Register Mask  */
...
typedef union { 
  struct {
    uint32_t BCNT:32;                   /**< bit:  0..31  Auto Padding Byte Counter                */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} AES_BCNT_Type;
#endif
...
#define AES_BCNT_OFFSET                     (0xB4)                                        /**<  (AES_BCNT) Byte Counter Register  Offset */

#define AES_BCNT_BCNT_Pos                   0                                              /**< (AES_BCNT) Auto Padding Byte Counter Position */
...
#define AES_BCNT_MASK                       _U_(0xFFFFFFFF)                                /**< \deprecated (AES_BCNT) Register MASK  (Use AES_BCNT_Msk instead)  */
...
typedef union { 
  struct {
    uint32_t TWEAK:32;                  /**< bit:  0..31  Tweak Word x                             */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} AES_TWR_Type;
#endif
...
#define AES_TWR_OFFSET                      (0xC0)                                        /**<  (AES_TWR) Tweak Word Register  Offset */

#define AES_TWR_TWEAK_Pos                   0                                              /**< (AES_TWR) Tweak Word x Position */
...
#define AES_TWR_MASK                        _U_(0xFFFFFFFF)                                /**< \deprecated (AES_TWR) Register MASK  (Use AES_TWR_Msk instead)  */
...
typedef union { 
  struct {
    uint32_t ALPHA:32;                  /**< bit:  0..31  Alpha Word x                             */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} AES_ALPHAR_Type;
#endif
...
#define AES_ALPHAR_OFFSET                   (0xD0)                                        /**<  (AES_ALPHAR) Alpha Word Register  Offset */

#define AES_ALPHAR_ALPHA_Pos                0                                              /**< (AES_ALPHAR) Alpha Word x Position */
...
#define AES_ALPHAR_MASK                     _U_(0xFFFFFFFF)                                /**< \deprecated (AES_ALPHAR) Register MASK  (Use AES_ALPHAR_Msk instead)  */
...
typedef struct {  
  ...
  __IO uint32_t AES_EMR;        /**< (AES Offset: 0xB0) Extended Mode Register */
  __IO uint32_t AES_BCNT;       /**< (AES Offset: 0xB4) Byte Counter Register */
  __I  uint8_t                        Reserved3[8];
  __IO uint32_t AES_TWR[4];     /**< (AES Offset: 0xC0) Tweak Word Register */
  __O  uint32_t AES_ALPHAR[4];  /**< (AES Offset: 0xD0) Alpha Word Register */
} Aes;
...
typedef struct {  
  ...
  __I  uint8_t                        Reserved2[4];
  __IO AES_EMR_Type                   AES_EMR;        /**< Offset: 0xB0 (R/W  32) Extended Mode Register */
  __IO AES_BCNT_Type                  AES_BCNT;       /**< Offset: 0xB4 (R/W  32) Byte Counter Register */
  __I  uint8_t                        Reserved3[8];
  __IO AES_TWR_Type                   AES_TWR[4];     /**< Offset: 0xC0 (R/W  32) Tweak Word Register */
  __O  AES_ALPHAR_Type                AES_ALPHAR[4];  /**< Offset: 0xD0 ( /W  32) Alpha Word Register */
} Aes;
