...
#define _SAMA5D2_QSPI_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Quad Serial Peripheral Interface
 *  @{
 */
/* ========================================================================== */
...
#define REV_QSPI N                      /**< (QSPI) Module revision */
...
typedef union { 
  struct {
    ...
    uint32_t SMRM:1;                    /**< bit:      3  Serial Memory Register Mode              */
    ...
    uint32_t PHYCR:1;                   /**< bit:     14  Physical Interface Clock Ratio           */
...
#define QSPI_MR_SMRM_Pos                    3                                              /**< (QSPI_MR) Serial Memory Register Mode Position */
#define QSPI_MR_SMRM_Msk                    (_U_(0x1) << QSPI_MR_SMRM_Pos)                 /**< (QSPI_MR) Serial Memory Register Mode Mask */
#define QSPI_MR_SMRM                        QSPI_MR_SMRM_Msk                               /**< \deprecated Old style mask definition for 1 bit bitfield. Use QSPI_MR_SMRM_Msk instead */
...
#define QSPI_MR_PHYCR_Pos                   14                                             /**< (QSPI_MR) Physical Interface Clock Ratio Position */
#define QSPI_MR_PHYCR_Msk                   (_U_(0x1) << QSPI_MR_PHYCR_Pos)                /**< (QSPI_MR) Physical Interface Clock Ratio Mask */
#define QSPI_MR_PHYCR                       QSPI_MR_PHYCR_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use QSPI_MR_PHYCR_Msk instead */
...
#define QSPI_MR_MASK                        _U_(0xFFFF4F3F)                                /**< \deprecated (QSPI_MR) Register MASK  (Use QSPI_MR_Msk instead)  */
...
typedef union { 
  struct {
    uint32_t RDRF:1;                    /**< bit:      0  Receive Data Register Full (cleared by reading QSPI_RDR) */
    uint32_t TDRE:1;                    /**< bit:      1  Transmit Data Register Empty (cleared by writing QSPI_TDR) */
    uint32_t TXEMPTY:1;                 /**< bit:      2  Transmission Registers Empty (cleared by writing QSPI_TDR) */
...
#define QSPI_SR_RDRF_Pos                    0                                              /**< (QSPI_SR) Receive Data Register Full (cleared by reading QSPI_RDR) Position */
...
#define QSPI_SR_TDRE_Pos                    1                                              /**< (QSPI_SR) Transmit Data Register Empty (cleared by writing QSPI_TDR) Position */
...
#define QSPI_SR_TXEMPTY_Pos                 2                                              /**< (QSPI_SR) Transmission Registers Empty (cleared by writing QSPI_TDR) Position */
