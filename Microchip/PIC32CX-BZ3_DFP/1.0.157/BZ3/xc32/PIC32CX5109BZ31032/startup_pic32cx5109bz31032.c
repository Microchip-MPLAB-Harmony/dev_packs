 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for PIC32CX5109BZ31032
 *
...
void Reserved40_Handler        ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
#else /* Legacy defined(_32CX5109BZ31032_H) */
