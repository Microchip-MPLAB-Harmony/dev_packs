...
#define _SAMA5D2_ICM_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Integrity Check Monitor
 *  @{
 */
/* ========================================================================== */
...
#define REV_ICM I                      /**< (ICM) Module revision */
...
typedef union { 
  struct {
    uint32_t ENABLE:1;                  /**< bit:      0  ICM Enable Register                      */
...
#define ICM_SR_ENABLE_Pos                   0                                              /**< (ICM_SR) ICM Enable Register Position */
...
#define ICM_UIHVAL_OFFSET                   (0x38)                                        /**<  (ICM_UIHVAL) User Initial Hash Value 0 Register  Offset */
...
typedef struct {  
  ...
  __O  uint32_t ICM_UIHVAL[8];  /**< (ICM Offset: 0x38) User Initial Hash Value 0 Register */
} Icm;
...
typedef struct {  
  ...
  __O  ICM_UIHVAL_Type                ICM_UIHVAL[8];  /**< Offset: 0x38 ( /W  32) User Initial Hash Value 0 Register */
} Icm;
