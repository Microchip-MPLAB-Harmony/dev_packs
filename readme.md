...
# MPLAB® Harmony 3 Device Family Packs
...
This repository contains the MPLAB® Harmony 3 Device Family Packs (DFP). Device Family Packs is structured directory of files that provide information related to each device family.
...
| ---        | ---                                |
| arm        | ARM CMSIS pack                     |
| Microchip  | Microchip device family packs      |
