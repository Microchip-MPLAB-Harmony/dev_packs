...
#define _SAMA5D2_RTC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Real-time Clock
 *  @{
 */
/* ========================================================================== */
...
#define REV_RTC ZE                     /**< (RTC) Module revision */
...
typedef union { 
  struct {
    uint32_t SEC:7;                     /**< bit:   0..6  Seconds of the Tamper                    */
    uint32_t :1;                        /**< bit:      7  Reserved */
    uint32_t MIN:7;                     /**< bit:  8..14  Minutes of the Tamper                    */
    uint32_t :1;                        /**< bit:     15  Reserved */
    uint32_t HOUR:6;                    /**< bit: 16..21  Hours of the Tamper                      */
    uint32_t AMPM:1;                    /**< bit:     22  AM/PM Indicator of the Tamper            */
    uint32_t :1;                        /**< bit:     23  Reserved */
    uint32_t TEVCNT:4;                  /**< bit: 24..27  Tamper Events Counter                    */
    uint32_t :3;                        /**< bit: 28..30  Reserved */
    uint32_t BACKUP:1;                  /**< bit:     31  System Mode of the Tamper                */
  } bit;                                /**< Structure used for bit  access */
  struct { // UTC mode
    uint32_t :32;                       /**< bit:  0..31  Reserved */
  } UTC;                                /**< Structure used for UTC mode access */
  uint32_t reg;                         /**< Type used for register access */
} RTC_TSTR_Type;
#endif
#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */

#define RTC_TSTR_OFFSET                     (0x00)                                        /**<  (RTC_TSTR) TimeStamp Time Register 0  Offset */

#define RTC_TSTR_SEC_Pos                    0                                              /**< (RTC_TSTR) Seconds of the Tamper Position */
...
#define RTC_TSTR_MIN_Pos                    8                                              /**< (RTC_TSTR) Minutes of the Tamper Position */
...
#define RTC_TSTR_HOUR_Pos                   16                                             /**< (RTC_TSTR) Hours of the Tamper Position */
...
#define RTC_TSTR_AMPM_Pos                   22                                             /**< (RTC_TSTR) AM/PM Indicator of the Tamper Position */
#define RTC_TSTR_AMPM_Msk                   (_U_(0x1) << RTC_TSTR_AMPM_Pos)                /**< (RTC_TSTR) AM/PM Indicator of the Tamper Mask */
#define RTC_TSTR_AMPM                       RTC_TSTR_AMPM_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSTR_AMPM_Msk instead */
#define RTC_TSTR_TEVCNT_Pos                 24                                             /**< (RTC_TSTR) Tamper Events Counter Position */
...
#define RTC_TSTR_BACKUP_Pos                 31                                             /**< (RTC_TSTR) System Mode of the Tamper Position */
#define RTC_TSTR_BACKUP_Msk                 (_U_(0x1) << RTC_TSTR_BACKUP_Pos)              /**< (RTC_TSTR) System Mode of the Tamper Mask */
#define RTC_TSTR_BACKUP                     RTC_TSTR_BACKUP_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSTR_BACKUP_Msk instead */
#define RTC_TSTR_MASK                       _U_(0x8F7F7F7F)                                /**< \deprecated (RTC_TSTR) Register MASK  (Use RTC_TSTR_Msk instead)  */
#define RTC_TSTR_Msk                        _U_(0x8F7F7F7F)                                /**< (RTC_TSTR) Register Mask  */

/* UTC mode */
#define RTC_TSTR_UTC_MASK                   _U_(0x00)                                      /**< \deprecated (RTC_TSTR_UTC) Register MASK  (Use RTC_TSTR_UTC_Msk instead)  */
#define RTC_TSTR_UTC_Msk                    _U_(0x00)                                      /**< (RTC_TSTR_UTC) Register Mask  */
...
typedef union { 
  struct {
    uint32_t CENT:7;                    /**< bit:   0..6  Century of the Tamper                    */
    uint32_t :1;                        /**< bit:      7  Reserved */
    uint32_t YEAR:8;                    /**< bit:  8..15  Year of the Tamper                       */
    uint32_t MONTH:5;                   /**< bit: 16..20  Month of the Tamper                      */
    uint32_t DAY:3;                     /**< bit: 21..23  Day of the Tamper                        */
    uint32_t DATE:6;                    /**< bit: 24..29  Date of the Tamper                       */
...
#define RTC_TSDR_OFFSET                     (0x04)                                        /**<  (RTC_TSDR) TimeStamp Date Register 0  Offset */

#define RTC_TSDR_CENT_Pos                   0                                              /**< (RTC_TSDR) Century of the Tamper Position */
...
#define RTC_TSDR_YEAR_Pos                   8                                              /**< (RTC_TSDR) Year of the Tamper Position */
...
#define RTC_TSDR_MONTH_Pos                  16                                             /**< (RTC_TSDR) Month of the Tamper Position */
...
#define RTC_TSDR_DAY_Pos                    21                                             /**< (RTC_TSDR) Day of the Tamper Position */
...
#define RTC_TSDR_DATE_Pos                   24                                             /**< (RTC_TSDR) Date of the Tamper Position */
...
#define RTC_TSDR_MASK                       _U_(0x3FFFFF7F)                                /**< \deprecated (RTC_TSDR) Register MASK  (Use RTC_TSDR_Msk instead)  */
#define RTC_TSDR_Msk                        _U_(0x3FFFFF7F)                                /**< (RTC_TSDR) Register Mask  */

/* UTC mode */
#define RTC_TSDR_UTC_MASK                   _U_(0x00)                                      /**< \deprecated (RTC_TSDR_UTC) Register MASK  (Use RTC_TSDR_UTC_Msk instead)  */
#define RTC_TSDR_UTC_Msk                    _U_(0x00)                                      /**< (RTC_TSDR_UTC) Register Mask  */
...
typedef union { 
  struct {
    ...
    uint32_t TST:1;                     /**< bit:      2  Test Pin Monitor                         */
    uint32_t JTAG:1;                    /**< bit:      3  JTAG Pins Monitor                        */
...
#define RTC_TSSR_OFFSET                     (0x08)                                        /**<  (RTC_TSSR) TimeStamp Source Register 0  Offset */

#define RTC_TSSR_TST_Pos                    2                                              /**< (RTC_TSSR) Test Pin Monitor Position */
#define RTC_TSSR_TST_Msk                    (_U_(0x1) << RTC_TSSR_TST_Pos)                 /**< (RTC_TSSR) Test Pin Monitor Mask */
#define RTC_TSSR_TST                        RTC_TSSR_TST_Msk                               /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_TST_Msk instead */
#define RTC_TSSR_JTAG_Pos                   3                                              /**< (RTC_TSSR) JTAG Pins Monitor Position */
#define RTC_TSSR_JTAG_Msk                   (_U_(0x1) << RTC_TSSR_JTAG_Pos)                /**< (RTC_TSSR) JTAG Pins Monitor Mask */
#define RTC_TSSR_JTAG                       RTC_TSSR_JTAG_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_JTAG_Msk instead */
#define RTC_TSSR_DET0_Pos                   16                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET0_Msk                   (_U_(0x1) << RTC_TSSR_DET0_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET0                       RTC_TSSR_DET0_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET0_Msk instead */
#define RTC_TSSR_DET1_Pos                   17                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET1_Msk                   (_U_(0x1) << RTC_TSSR_DET1_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET1                       RTC_TSSR_DET1_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET1_Msk instead */
#define RTC_TSSR_DET2_Pos                   18                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET2_Msk                   (_U_(0x1) << RTC_TSSR_DET2_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET2                       RTC_TSSR_DET2_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET2_Msk instead */
#define RTC_TSSR_DET3_Pos                   19                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET3_Msk                   (_U_(0x1) << RTC_TSSR_DET3_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET3                       RTC_TSSR_DET3_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET3_Msk instead */
#define RTC_TSSR_DET4_Pos                   20                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET4_Msk                   (_U_(0x1) << RTC_TSSR_DET4_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET4                       RTC_TSSR_DET4_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET4_Msk instead */
#define RTC_TSSR_DET5_Pos                   21                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET5_Msk                   (_U_(0x1) << RTC_TSSR_DET5_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET5                       RTC_TSSR_DET5_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET5_Msk instead */
#define RTC_TSSR_DET6_Pos                   22                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET6_Msk                   (_U_(0x1) << RTC_TSSR_DET6_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET6                       RTC_TSSR_DET6_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET6_Msk instead */
#define RTC_TSSR_DET7_Pos                   23                                             /**< (RTC_TSSR) PIOBU Intrusion Detector Position */
#define RTC_TSSR_DET7_Msk                   (_U_(0x1) << RTC_TSSR_DET7_Pos)                /**< (RTC_TSSR) PIOBU Intrusion Detector Mask */
#define RTC_TSSR_DET7                       RTC_TSSR_DET7_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_TSSR_DET7_Msk instead */
#define RTC_TSSR_MASK                       _U_(0xFF000C)                                  /**< \deprecated (RTC_TSSR) Register MASK  (Use RTC_TSSR_Msk instead)  */
#define RTC_TSSR_Msk                        _U_(0xFF000C)                                  /**< (RTC_TSSR) Register Mask  */

#define RTC_TSSR_DET_Pos                    16                                             /**< (RTC_TSSR Position) PIOBU Intrusion Detector */
...
typedef union { 
  struct {
    ...
    uint32_t UTC:1;                     /**< bit:      2  UTC Time Format                          */
...
#define RTC_MR_UTC_Pos                      2                                              /**< (RTC_MR) UTC Time Format Position */
#define RTC_MR_UTC_Msk                      (_U_(0x1) << RTC_MR_UTC_Pos)                   /**< (RTC_MR) UTC Time Format Mask */
#define RTC_MR_UTC                          RTC_MR_UTC_Msk                                 /**< \deprecated Old style mask definition for 1 bit bitfield. Use RTC_MR_UTC_Msk instead */
...
#define RTC_MR_MASK                         _U_(0x3777FF17)                                /**< \deprecated (RTC_MR) Register MASK  (Use RTC_MR_Msk instead)  */
...
/* UTC mode */
#define RTC_TIMR_UTC_MASK                   _U_(0x00)                                      /**< \deprecated (RTC_TIMR_UTC) Register MASK  (Use RTC_TIMR_UTC_Msk instead)  */
#define RTC_TIMR_UTC_Msk                    _U_(0x00)                                      /**< (RTC_TIMR_UTC) Register Mask  */
...
/* UTC mode */
#define RTC_TIMALR_UTC_MASK                 _U_(0x00)                                      /**< \deprecated (RTC_TIMALR_UTC) Register MASK  (Use RTC_TIMALR_UTC_Msk instead)  */
#define RTC_TIMALR_UTC_Msk                  _U_(0x00)                                      /**< (RTC_TIMALR_UTC) Register Mask  */
...
/* UTC mode */
#define RTC_CALALR_UTC_MASK                 _U_(0x00)                                      /**< \deprecated (RTC_CALALR_UTC) Register MASK  (Use RTC_CALALR_UTC_Msk instead)  */
#define RTC_CALALR_UTC_Msk                  _U_(0x00)                                      /**< (RTC_CALALR_UTC) Register Mask  */
...
/** \brief RTC_TS hardware registers */
typedef struct {  
  __I  uint32_t RTC_TSTR;       /**< (RTC_TS Offset: 0x00) TimeStamp Time Register 0 */
  __I  uint32_t RTC_TSDR;       /**< (RTC_TS Offset: 0x04) TimeStamp Date Register 0 */
  __I  uint32_t RTC_TSSR;       /**< (RTC_TS Offset: 0x08) TimeStamp Source Register 0 */
} RtcTs;
...
typedef struct {  
  ...
  __I  uint8_t                        Reserved1[128];
       RtcTs    RtcTs[RTCTS_NUMBER]; /**< Offset: 0xB0  */
} Rtc;

#elif COMPONENT_TYPEDEF_STYLE == 'N'
/** \brief RTC_TS hardware registers */
typedef struct {  
  __I  RTC_TSTR_Type                  RTC_TSTR;       /**< Offset: 0x00 (R/   32) TimeStamp Time Register 0 */
  __I  RTC_TSDR_Type                  RTC_TSDR;       /**< Offset: 0x04 (R/   32) TimeStamp Date Register 0 */
  __I  RTC_TSSR_Type                  RTC_TSSR;       /**< Offset: 0x08 (R/   32) TimeStamp Source Register 0 */
} RtcTs;
