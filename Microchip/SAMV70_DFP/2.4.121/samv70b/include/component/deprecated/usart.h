...
#ifndef _SAMV70_USART_COMPONENT_DEPRECATED_H_
#define _SAMV70_USART_COMPONENT_DEPRECATED_H_
...
#define US_MR_MAX_ITERATION(value) DEPRECATED(US_MR_MAX_ITERATION(value), "Using deprecated macro US_MR_MAX_ITERATION(value)") (US_MR_MAX_ITERATION_Msk & ((value) << US_MR_MAX_ITERATION_Pos))
