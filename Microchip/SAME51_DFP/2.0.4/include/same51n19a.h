...
typedef enum IRQn
{
  ...
  OSCCTRL_XOSC0_IRQn       =  2, /**<  2 SAME51N19A Oscillators Control (OSCCTRL): OSCCTRL_XOSCFAIL_0, OSCCTRL_XOSCRDY_0 */
  OSCCTRL_XOSC1_IRQn       =  3, /**<  3 SAME51N19A Oscillators Control (OSCCTRL): OSCCTRL_XOSCFAIL_1, OSCCTRL_XOSCRDY_1 */
  OSCCTRL_DFLL_IRQn        =  4, /**<  4 SAME51N19A Oscillators Control (OSCCTRL): OSCCTRL_DFLLLOCKC, OSCCTRL_DFLLLOCKF, OSCCTRL_DFLLOOB, OSCCTRL_DFLLRCS, OSCCTRL_DFLLRDY */
  OSCCTRL_DPLL0_IRQn       =  5, /**<  5 SAME51N19A Oscillators Control (OSCCTRL): OSCCTRL_DPLLLCKF_0, OSCCTRL_DPLLLCKR_0, OSCCTRL_DPLLLDRTO_0, OSCCTRL_DPLLLTO_0 */
  OSCCTRL_DPLL1_IRQn       =  6, /**<  6 SAME51N19A Oscillators Control (OSCCTRL): OSCCTRL_DPLLLCKF_1, OSCCTRL_DPLLLCKR_1, OSCCTRL_DPLLLDRTO_1, OSCCTRL_DPLLLTO_1 */
  OSC32KCTRL_IRQn          =  7, /**<  7 SAME51N19A 32kHz Oscillators Control (OSC32KCTRL) */
  SUPC_OTHER_IRQn          =  8, /**<  8 SAME51N19A Supply Controller (SUPC): SUPC_B12SRDY, SUPC_B33SRDY, SUPC_BOD12RDY, SUPC_BOD33RDY, SUPC_VCORERDY, SUPC_VREGRDY */
  SUPC_BODDET_IRQn         =  9, /**<  9 SAME51N19A Supply Controller (SUPC): SUPC_BOD12DET, SUPC_BOD33DET */
  WDT_IRQn                 = 10, /**< 10 SAME51N19A Watchdog Timer (WDT) */
  RTC_IRQn                 = 11, /**< 11 SAME51N19A Real-Time Counter (RTC) */
  EIC_EXTINT_0_IRQn        = 12, /**< 12 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_0 */
  EIC_EXTINT_1_IRQn        = 13, /**< 13 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_1 */
  EIC_EXTINT_2_IRQn        = 14, /**< 14 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_2 */
  EIC_EXTINT_3_IRQn        = 15, /**< 15 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_3 */
  EIC_EXTINT_4_IRQn        = 16, /**< 16 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_4 */
  EIC_EXTINT_5_IRQn        = 17, /**< 17 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_5 */
  EIC_EXTINT_6_IRQn        = 18, /**< 18 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_6 */
  EIC_EXTINT_7_IRQn        = 19, /**< 19 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_7 */
  EIC_EXTINT_8_IRQn        = 20, /**< 20 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_8 */
  EIC_EXTINT_9_IRQn        = 21, /**< 21 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_9 */
  EIC_EXTINT_10_IRQn       = 22, /**< 22 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_10 */
  EIC_EXTINT_11_IRQn       = 23, /**< 23 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_11 */
  EIC_EXTINT_12_IRQn       = 24, /**< 24 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_12 */
  EIC_EXTINT_13_IRQn       = 25, /**< 25 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_13 */
  EIC_EXTINT_14_IRQn       = 26, /**< 26 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_14 */
  EIC_EXTINT_15_IRQn       = 27, /**< 27 SAME51N19A External Interrupt Controller (EIC): EIC_EXTINT_15 */
  ...
  EVSYS_OTHER_IRQn         = 40, /**< 40 SAME51N19A Event System Interface (EVSYS): EVSYS_EVD_10, EVSYS_EVD_11, EVSYS_EVD_4, EVSYS_EVD_5, EVSYS_EVD_6, EVSYS_EVD_7, EVSYS_EVD_8, EVSYS_EVD_9, EVSYS_OVR_10, EVSYS_OVR_11, EVSYS_OVR_4, EVSYS_OVR_5, EVSYS_OVR_6, EVSYS_OVR_7, EVSYS_OVR_8, EVSYS_OVR_9 */
  ...
  SERCOM0_OTHER_IRQn       = 49, /**< 49 SAME51N19A Serial Communication Interface 0 (SERCOM0): SERCOM0_3, SERCOM0_4, SERCOM0_5, SERCOM0_6 */
  ...
  SERCOM1_OTHER_IRQn       = 53, /**< 53 SAME51N19A Serial Communication Interface 1 (SERCOM1): SERCOM1_3, SERCOM1_4, SERCOM1_5, SERCOM1_6 */
  ...
  SERCOM2_OTHER_IRQn       = 57, /**< 57 SAME51N19A Serial Communication Interface 2 (SERCOM2): SERCOM2_3, SERCOM2_4, SERCOM2_5, SERCOM2_6 */
  ...
  SERCOM3_OTHER_IRQn       = 61, /**< 61 SAME51N19A Serial Communication Interface 3 (SERCOM3): SERCOM3_3, SERCOM3_4, SERCOM3_5, SERCOM3_6 */
  ...
  SERCOM4_OTHER_IRQn       = 65, /**< 65 SAME51N19A Serial Communication Interface 4 (SERCOM4): SERCOM4_3, SERCOM4_4, SERCOM4_5, SERCOM4_6 */
  ...
  SERCOM5_OTHER_IRQn       = 69, /**< 69 SAME51N19A Serial Communication Interface 5 (SERCOM5): SERCOM5_3, SERCOM5_4, SERCOM5_5, SERCOM5_6 */
  ...
  SERCOM6_OTHER_IRQn       = 73, /**< 73 SAME51N19A Serial Communication Interface 6 (SERCOM6): SERCOM6_3, SERCOM6_4, SERCOM6_5, SERCOM6_6 */
  ...
  SERCOM7_OTHER_IRQn       = 77, /**< 77 SAME51N19A Serial Communication Interface 7 (SERCOM7): SERCOM7_3, SERCOM7_4, SERCOM7_5, SERCOM7_6 */
  CAN0_IRQn                = 78, /**< 78 SAME51N19A Control Area Network 0 (CAN0) */
  CAN1_IRQn                = 79, /**< 79 SAME51N19A Control Area Network 1 (CAN1) */
  USB_OTHER_IRQn           = 80, /**< 80 SAME51N19A Universal Serial Bus (USB): USB_EORSM_DNRSM, USB_EORST_RST, USB_LPMSUSP_DDISC, USB_LPM_DCONN, USB_MSOF, USB_RAMACER, USB_RXSTP_TXSTP_0, USB_RXSTP_TXSTP_1, USB_RXSTP_TXSTP_2, USB_RXSTP_TXSTP_3, USB_RXSTP_TXSTP_4, USB_RXSTP_TXSTP_5, USB_RXSTP_TXSTP_6, USB_RXSTP_TXSTP_7, USB_STALL0_STALL_0, USB_STALL0_STALL_1, USB_STALL0_STALL_2, USB_STALL0_STALL_3, USB_STALL0_STALL_4, USB_STALL0_STALL_5, USB_STALL0_STALL_6, USB_STALL0_STALL_7, USB_STALL1_0, USB_STALL1_1, USB_STALL1_2, USB_STALL1_3, USB_STALL1_4, USB_STALL1_5, USB_STALL1_6, USB_STALL1_7, USB_SUSPEND, USB_TRFAIL0_TRFAIL_0, USB_TRFAIL0_TRFAIL_1, USB_TRFAIL0_TRFAIL_2, USB_TRFAIL0_TRFAIL_3, USB_TRFAIL0_TRFAIL_4, USB_TRFAIL0_TRFAIL_5, USB_TRFAIL0_TRFAIL_6, USB_TRFAIL0_TRFAIL_7, USB_TRFAIL1_PERR_0, USB_TRFAIL1_PERR_1, USB_TRFAIL1_PERR_2, USB_TRFAIL1_PERR_3, USB_TRFAIL1_PERR_4, USB_TRFAIL1_PERR_5, USB_TRFAIL1_PERR_6, USB_TRFAIL1_PERR_7, USB_UPRSM, USB_WAKEUP */
  USB_SOF_HSOF_IRQn        = 81, /**< 81 SAME51N19A Universal Serial Bus (USB): USB_SOF_HSOF */
  USB_TRCPT0_IRQn          = 82, /**< 82 SAME51N19A Universal Serial Bus (USB): USB_TRCPT0_0, USB_TRCPT0_1, USB_TRCPT0_2, USB_TRCPT0_3, USB_TRCPT0_4, USB_TRCPT0_5, USB_TRCPT0_6, USB_TRCPT0_7 */
  USB_TRCPT1_IRQn          = 83, /**< 83 SAME51N19A Universal Serial Bus (USB): USB_TRCPT1_0, USB_TRCPT1_1, USB_TRCPT1_2, USB_TRCPT1_3, USB_TRCPT1_4, USB_TRCPT1_5, USB_TRCPT1_6, USB_TRCPT1_7 */
  TCC0_OTHER_IRQn          = 85, /**< 85 SAME51N19A Timer Counter Control 0 (TCC0): TCC0_CNT_A, TCC0_DFS_A, TCC0_ERR_A, TCC0_FAULT0_A, TCC0_FAULT1_A, TCC0_FAULTA_A, TCC0_FAULTB_A, TCC0_OVF, TCC0_TRG, TCC0_UFS_A */
  TCC0_MC0_IRQn            = 86, /**< 86 SAME51N19A Timer Counter Control 0 (TCC0): TCC0_MC_0 */
  TCC0_MC1_IRQn            = 87, /**< 87 SAME51N19A Timer Counter Control 0 (TCC0): TCC0_MC_1 */
  TCC0_MC2_IRQn            = 88, /**< 88 SAME51N19A Timer Counter Control 0 (TCC0): TCC0_MC_2 */
  TCC0_MC3_IRQn            = 89, /**< 89 SAME51N19A Timer Counter Control 0 (TCC0): TCC0_MC_3 */
  TCC0_MC4_IRQn            = 90, /**< 90 SAME51N19A Timer Counter Control 0 (TCC0): TCC0_MC_4 */
  TCC0_MC5_IRQn            = 91, /**< 91 SAME51N19A Timer Counter Control 0 (TCC0): TCC0_MC_5 */
  TCC1_OTHER_IRQn          = 92, /**< 92 SAME51N19A Timer Counter Control 1 (TCC1): TCC1_CNT_A, TCC1_DFS_A, TCC1_ERR_A, TCC1_FAULT0_A, TCC1_FAULT1_A, TCC1_FAULTA_A, TCC1_FAULTB_A, TCC1_OVF, TCC1_TRG, TCC1_UFS_A */
  TCC1_MC0_IRQn            = 93, /**< 93 SAME51N19A Timer Counter Control 1 (TCC1): TCC1_MC_0 */
  TCC1_MC1_IRQn            = 94, /**< 94 SAME51N19A Timer Counter Control 1 (TCC1): TCC1_MC_1 */
  TCC1_MC2_IRQn            = 95, /**< 95 SAME51N19A Timer Counter Control 1 (TCC1): TCC1_MC_2 */
  TCC1_MC3_IRQn            = 96, /**< 96 SAME51N19A Timer Counter Control 1 (TCC1): TCC1_MC_3 */
  TCC2_OTHER_IRQn          = 97, /**< 97 SAME51N19A Timer Counter Control 2 (TCC2): TCC2_CNT_A, TCC2_DFS_A, TCC2_ERR_A, TCC2_FAULT0_A, TCC2_FAULT1_A, TCC2_FAULTA_A, TCC2_FAULTB_A, TCC2_OVF, TCC2_TRG, TCC2_UFS_A */
  TCC2_MC0_IRQn            = 98, /**< 98 SAME51N19A Timer Counter Control 2 (TCC2): TCC2_MC_0 */
  TCC2_MC1_IRQn            = 99, /**< 99 SAME51N19A Timer Counter Control 2 (TCC2): TCC2_MC_1 */
  TCC2_MC2_IRQn            = 100, /**< 100 SAME51N19A Timer Counter Control 2 (TCC2): TCC2_MC_2 */
  TCC3_OTHER_IRQn          = 101, /**< 101 SAME51N19A Timer Counter Control 3 (TCC3): TCC3_CNT_A, TCC3_DFS_A, TCC3_ERR_A, TCC3_FAULT0_A, TCC3_FAULT1_A, TCC3_FAULTA_A, TCC3_FAULTB_A, TCC3_OVF, TCC3_TRG, TCC3_UFS_A */
  TCC3_MC0_IRQn            = 102, /**< 102 SAME51N19A Timer Counter Control 3 (TCC3): TCC3_MC_0 */
  TCC3_MC1_IRQn            = 103, /**< 103 SAME51N19A Timer Counter Control 3 (TCC3): TCC3_MC_1 */
  TCC4_OTHER_IRQn          = 104, /**< 104 SAME51N19A Timer Counter Control 4 (TCC4): TCC4_CNT_A, TCC4_DFS_A, TCC4_ERR_A, TCC4_FAULT0_A, TCC4_FAULT1_A, TCC4_FAULTA_A, TCC4_FAULTB_A, TCC4_OVF, TCC4_TRG, TCC4_UFS_A */
  TCC4_MC0_IRQn            = 105, /**< 105 SAME51N19A Timer Counter Control 4 (TCC4): TCC4_MC_0 */
  TCC4_MC1_IRQn            = 106, /**< 106 SAME51N19A Timer Counter Control 4 (TCC4): TCC4_MC_1 */
  ...
  PDEC_OTHER_IRQn          = 115, /**< 115 SAME51N19A Quadrature Decodeur (PDEC): PDEC_DIR_A, PDEC_ERR_A, PDEC_OVF, PDEC_VLC_A */
  PDEC_MC0_IRQn            = 116, /**< 116 SAME51N19A Quadrature Decodeur (PDEC): PDEC_MC_0 */
  PDEC_MC1_IRQn            = 117, /**< 117 SAME51N19A Quadrature Decodeur (PDEC): PDEC_MC_1 */
  ADC0_OTHER_IRQn          = 118, /**< 118 SAME51N19A Analog Digital Converter 0 (ADC0): ADC0_OVERRUN, ADC0_WINMON */
  ADC0_RESRDY_IRQn         = 119, /**< 119 SAME51N19A Analog Digital Converter 0 (ADC0): ADC0_RESRDY */
  ADC1_OTHER_IRQn          = 120, /**< 120 SAME51N19A Analog Digital Converter 1 (ADC1): ADC1_OVERRUN, ADC1_WINMON */
  ADC1_RESRDY_IRQn         = 121, /**< 121 SAME51N19A Analog Digital Converter 1 (ADC1): ADC1_RESRDY */
  AC_IRQn                  = 122, /**< 122 SAME51N19A Analog Comparators (AC) */
  DAC_OTHER_IRQn           = 123, /**< 123 SAME51N19A Digital-to-Analog Converter (DAC): DAC_OVERRUN_A_0, DAC_OVERRUN_A_1, DAC_UNDERRUN_A_0, DAC_UNDERRUN_A_1 */
  DAC_EMPTY_0_IRQn         = 124, /**< 124 SAME51N19A Digital-to-Analog Converter (DAC): DAC_EMPTY_0 */
  DAC_EMPTY_1_IRQn         = 125, /**< 125 SAME51N19A Digital-to-Analog Converter (DAC): DAC_EMPTY_1 */
  DAC_RESRDY_0_IRQn        = 126, /**< 126 SAME51N19A Digital-to-Analog Converter (DAC): DAC_RESRDY_0 */
  DAC_RESRDY_1_IRQn        = 127, /**< 127 SAME51N19A Digital-to-Analog Converter (DAC): DAC_RESRDY_1 */
