...
def reset_peripherals():
    ...
    dev.Write32(0xE001D000, 0xA5000008)  # Software reset (using RSTC_CR)
    #dev.Write32(0x00A00100, 0x0)         # Reset L2 Cache controller
    dev.Write32(0xE001C000, 0xA5000001)  # Reset Watchdog (using NS_WDT_CR)
    dev.Write32(0xE001D180, 0xA5000001)  # Reset Watchdog (using PS_WDT_CR)
    ...
    if has_reset and settings.getBool("programoptions.resetafterprogram", False):
        ...
        for i in range(40):
            try:
                ...
                dev.Delay(50000) #give the board time to receover after reset
