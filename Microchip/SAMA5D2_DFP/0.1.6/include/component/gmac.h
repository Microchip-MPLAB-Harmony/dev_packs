...
#define _SAMA5D2_GMAC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Gigabit Ethernet MAC
 *  @{
 */
/* ========================================================================== */
...
#define GMAC_44152                      /**< (GMAC) Module ID */
#define REV_GMAC A                      /**< (GMAC) Module revision */
...
typedef union { 
  struct {
    ...
    uint32_t SRTSM:1;                   /**< bit:     15  Store Receive Timestamp to Memory        */
...
#define GMAC_NCR_SRTSM_Pos                  15                                             /**< (GMAC_NCR) Store Receive Timestamp to Memory Position */
...
#define GMAC_ISRPQ_OFFSET                   (0x400)                                       /**<  (GMAC_ISRPQ) Interrupt Status Register Priority Queue (1..2)  Offset */
...
#define GMAC_TBQBAPQ_OFFSET                 (0x440)                                       /**<  (GMAC_TBQBAPQ) Transmit Buffer Queue Base Address Register Priority Queue (1..2)  Offset */
...
#define GMAC_RBQBAPQ_OFFSET                 (0x480)                                       /**<  (GMAC_RBQBAPQ) Receive Buffer Queue Base Address Register Priority Queue (1..2)  Offset */
...
#define GMAC_RBSRPQ_OFFSET                  (0x4A0)                                       /**<  (GMAC_RBSRPQ) Receive Buffer Size Register Priority Queue (1..2)  Offset */
...
#define GMAC_IERPQ_OFFSET                   (0x600)                                       /**<  (GMAC_IERPQ) Interrupt Enable Register Priority Queue (1..2)  Offset */
...
#define GMAC_IDRPQ_OFFSET                   (0x620)                                       /**<  (GMAC_IDRPQ) Interrupt Disable Register Priority Queue (1..2)  Offset */
...
#define GMAC_IMRPQ_OFFSET                   (0x640)                                       /**<  (GMAC_IMRPQ) Interrupt Mask Register Priority Queue (1..2)  Offset */
...
typedef struct {  
  ...
  __I  uint32_t GMAC_ISRPQ[2];  /**< (GMAC Offset: 0x400) Interrupt Status Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved8[56];
  __IO uint32_t GMAC_TBQBAPQ[2]; /**< (GMAC Offset: 0x440) Transmit Buffer Queue Base Address Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved9[56];
  __IO uint32_t GMAC_RBQBAPQ[2]; /**< (GMAC Offset: 0x480) Receive Buffer Queue Base Address Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved10[24];
  __IO uint32_t GMAC_RBSRPQ[2]; /**< (GMAC Offset: 0x4A0) Receive Buffer Size Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved11[20];
  ...
  __O  uint32_t GMAC_IERPQ[2];  /**< (GMAC Offset: 0x600) Interrupt Enable Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved15[24];
  __O  uint32_t GMAC_IDRPQ[2];  /**< (GMAC Offset: 0x620) Interrupt Disable Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved16[24];
  __IO uint32_t GMAC_IMRPQ[2];  /**< (GMAC Offset: 0x640) Interrupt Mask Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved17[152];
...
typedef struct {  
  ...
  __I  uint8_t                        Reserved7[384];
  __I  GMAC_ISRPQ_Type                GMAC_ISRPQ[2];  /**< Offset: 0x400 (R/   32) Interrupt Status Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved8[56];
  __IO GMAC_TBQBAPQ_Type              GMAC_TBQBAPQ[2]; /**< Offset: 0x440 (R/W  32) Transmit Buffer Queue Base Address Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved9[56];
  __IO GMAC_RBQBAPQ_Type              GMAC_RBQBAPQ[2]; /**< Offset: 0x480 (R/W  32) Receive Buffer Queue Base Address Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved10[24];
  __IO GMAC_RBSRPQ_Type               GMAC_RBSRPQ[2]; /**< Offset: 0x4A0 (R/W  32) Receive Buffer Size Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved11[20];
  ...
  __I  uint8_t                        Reserved14[160];
  __O  GMAC_IERPQ_Type                GMAC_IERPQ[2];  /**< Offset: 0x600 ( /W  32) Interrupt Enable Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved15[24];
  __O  GMAC_IDRPQ_Type                GMAC_IDRPQ[2];  /**< Offset: 0x620 ( /W  32) Interrupt Disable Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved16[24];
  __IO GMAC_IMRPQ_Type                GMAC_IMRPQ[2];  /**< Offset: 0x640 (R/W  32) Interrupt Mask Register Priority Queue (1..2) */
  __I  uint8_t                        Reserved17[152];
