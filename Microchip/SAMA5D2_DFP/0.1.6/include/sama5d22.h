 ...
 * \file
 *
 * \brief Header file for ATSAMA5D22
 *
...
/* file generated from device description version 2019-01-23T22:42:03Z */
#ifndef _SAMA5D22_H_
#define _SAMA5D22_H_
...
/** \addtogroup SAMA5D22_cmsis CMSIS Definitions
 *  @{
 */
/* ************************************************************************** */
...
/******  SAMA5D22 specific Interrupt Numbers ***********************************/
  SAIC_IRQn                 = 0  , /**< 0   SAMA5D22 Advanced Interrupt Controller (SAIC) */
  PIT_IRQn                  = 3  , /**< 3   SAMA5D22 Periodic Interval Timer (PIT) */
  WDT_IRQn                  = 4  , /**< 4   SAMA5D22 Watchdog Timer (WDT)       */
  GMAC_IRQn                 = 5  , /**< 5   SAMA5D22 Gigabit Ethernet MAC (GMAC) */
  XDMAC0_IRQn               = 6  , /**< 6   SAMA5D22 Extensible DMA Controller (XDMAC0) */
  XDMAC1_IRQn               = 7  , /**< 7   SAMA5D22 Extensible DMA Controller (XDMAC1) */
  ICM_IRQn                  = 8  , /**< 8   SAMA5D22 Integrity Check Monitor (ICM) */
  AES_IRQn                  = 9  , /**< 9   SAMA5D22 Advanced Encryption Standard (AES) */
  AESB_IRQn                 = 10 , /**< 10  SAMA5D22 Advanced Encryption Standard Bridge (AESB) */
  TDES_IRQn                 = 11 , /**< 11  SAMA5D22 Triple Data Encryption Standard (TDES) */
  SHA_IRQn                  = 12 , /**< 12  SAMA5D22 Secure Hash Algorithm (SHA) */
  MPDDRC_IRQn               = 13 , /**< 13  SAMA5D22 AHB Multiport DDR-SDRAM Controller (MPDDRC) */
  MATRIX1_IRQn              = 14 , /**< 14  SAMA5D22 AHB Bus Matrix (MATRIX1)   */
  MATRIX0_IRQn              = 15 , /**< 15  SAMA5D22 AHB Bus Matrix (MATRIX0)   */
  SECUMOD_IRQn              = 16 , /**< 16  SAMA5D22 Security Module (SECUMOD)  */
  PIOA_IRQn                 = 18 , /**< 18  SAMA5D22 Parallel Input/Output Controller (PIOA) */
  FLEXCOM0_IRQn             = 19 , /**< 19  SAMA5D22 Flexible Serial Communication (FLEXCOM0) */
  FLEXCOM1_IRQn             = 20 , /**< 20  SAMA5D22 Flexible Serial Communication (FLEXCOM1) */
  FLEXCOM3_IRQn             = 22 , /**< 22  SAMA5D22 Flexible Serial Communication (FLEXCOM3) */
  FLEXCOM4_IRQn             = 23 , /**< 23  SAMA5D22 Flexible Serial Communication (FLEXCOM4) */
  UART0_IRQn                = 24 , /**< 24  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART0) */
  UART1_IRQn                = 25 , /**< 25  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART1) */
  UART2_IRQn                = 26 , /**< 26  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART2) */
  UART3_IRQn                = 27 , /**< 27  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART3) */
  UART4_IRQn                = 28 , /**< 28  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART4) */
  TWIHS0_IRQn               = 29 , /**< 29  SAMA5D22 Two-wire Interface High Speed (TWIHS0) */
  TWIHS1_IRQn               = 30 , /**< 30  SAMA5D22 Two-wire Interface High Speed (TWIHS1) */
  SDMMC1_IRQn               = 32 , /**< 32  SAMA5D22 Secure Digital MultiMedia Card Controller (SDMMC1) */
  SPI0_IRQn                 = 33 , /**< 33  SAMA5D22 Serial Peripheral Interface (SPI0) */
  SPI1_IRQn                 = 34 , /**< 34  SAMA5D22 Serial Peripheral Interface (SPI1) */
  TC0_IRQn                  = 35 , /**< 35  SAMA5D22 Timer Counter (TC0)        */
  TC1_IRQn                  = 36 , /**< 36  SAMA5D22 Timer Counter (TC0)        */
  PWM_IRQn                  = 38 , /**< 38  SAMA5D22 Pulse Width Modulation Controller (PWM) */
  ADC_IRQn                  = 40 , /**< 40  SAMA5D22 Analog-to-Digital Converter (ADC) */
  UDPHS_IRQn                = 42 , /**< 42  SAMA5D22 USB High Speed Device Port (UDPHS) */
  SSC0_IRQn                 = 43 , /**< 43  SAMA5D22 Synchronous Serial Controller (SSC0) */
  SSC1_IRQn                 = 44 , /**< 44  SAMA5D22 Synchronous Serial Controller (SSC1) */
  LCDC_IRQn                 = 45 , /**< 45  SAMA5D22 LCD Controller (LCDC)      */
  ISC_IRQn                  = 46 , /**< 46  SAMA5D22 Image Sensor Controller (ISC) */
  TRNG_IRQn                 = 47 , /**< 47  SAMA5D22 True Random Number Generator (TRNG) */
  PDMIC_IRQn                = 48 , /**< 48  SAMA5D22 Pulse Density Modulation Interface Controller (PDMIC) */
  AIC_IRQn                  = 49 , /**< 49  SAMA5D22 Advanced Interrupt Controller (AIC) */
  SFC_IRQn                  = 50 , /**< 50  SAMA5D22 Secure Fuse Controller (SFC) */
  QSPI0_IRQn                = 52 , /**< 52  SAMA5D22 Quad Serial Peripheral Interface (QSPI0) */
  QSPI1_IRQn                = 53 , /**< 53  SAMA5D22 Quad Serial Peripheral Interface (QSPI1) */
  I2SC0_IRQn                = 54 , /**< 54  SAMA5D22 Inter-IC Sound Controller (I2SC0) */
  I2SC1_IRQn                = 55 , /**< 55  SAMA5D22 Inter-IC Sound Controller (I2SC1) */
  MCAN0_INT0_IRQn           = 56 , /**< 56  SAMA5D22 Controller Area Network (MCAN0) */
  PTC_IRQn                  = 58 , /**< 58  SAMA5D22 Peripheral Touch Controller (PTC) */
  CLASSD_IRQn               = 59 , /**< 59  SAMA5D22 Audio Class D Amplifier (CLASSD) (CLASSD) */
  L2CC_IRQn                 = 63 , /**< 63  SAMA5D22 L2 Cache Controller (L2CC) */
  MCAN0_INT1_IRQn           = 64 , /**< 64  SAMA5D22 Controller Area Network (MCAN0) */
  GMAC_Q1_IRQn              = 66 , /**< 66  SAMA5D22 Gigabit Ethernet MAC (GMAC) */
  GMAC_Q2_IRQn              = 67 , /**< 67  SAMA5D22 Gigabit Ethernet MAC (GMAC) */
  PIOB_IRQn                 = 68 , /**< 68  SAMA5D22 Parallel Input/Output Controller (PIOB) */
  PIOC_IRQn                 = 69 , /**< 69  SAMA5D22 Parallel Input/Output Controller (PIOC) */
  PIOD_IRQn                 = 70 , /**< 70  SAMA5D22 Parallel Input/Output Controller (PIOD) */
  SDMMC1_TIMER_IRQn         = 72 , /**< 72  SAMA5D22 Secure Digital MultiMedia Card Controller (SDMMC1) */
  SYSC_IRQn                 = 74 , /**< 74  SAMA5D22 Power Management Controller (PMC) */
  ACC_IRQn                  = 75 , /**< 75  SAMA5D22 Analog Comparator Controller (ACC) */
  RXLP_IRQn                 = 76 , /**< 76  SAMA5D22 Low Power Asynchronous Receiver (RXLP) */
...
typedef struct _DeviceVectors
{
  ...
  /* Peripheral handlers */
  void* pfnSAIC_Handler;                         /* 0   SAMA5D22 Advanced Interrupt Controller (SAIC) */
  void* pvReserved1;
  void* pvReserved2;
  void* pfnPIT_Handler;                          /* 3   SAMA5D22 Periodic Interval Timer (PIT) */
  void* pfnWDT_Handler;                          /* 4   SAMA5D22 Watchdog Timer (WDT)  */
  void* pfnGMAC_Handler;                         /* 5   SAMA5D22 Gigabit Ethernet MAC (GMAC) */
  void* pfnXDMAC0_Handler;                       /* 6   SAMA5D22 Extensible DMA Controller (XDMAC0) */
  void* pfnXDMAC1_Handler;                       /* 7   SAMA5D22 Extensible DMA Controller (XDMAC1) */
  void* pfnICM_Handler;                          /* 8   SAMA5D22 Integrity Check Monitor (ICM) */
  void* pfnAES_Handler;                          /* 9   SAMA5D22 Advanced Encryption Standard (AES) */
  void* pfnAESB_Handler;                         /* 10  SAMA5D22 Advanced Encryption Standard Bridge (AESB) */
  void* pfnTDES_Handler;                         /* 11  SAMA5D22 Triple Data Encryption Standard (TDES) */
  void* pfnSHA_Handler;                          /* 12  SAMA5D22 Secure Hash Algorithm (SHA) */
  void* pfnMPDDRC_Handler;                       /* 13  SAMA5D22 AHB Multiport DDR-SDRAM Controller (MPDDRC) */
  void* pfnMATRIX1_Handler;                      /* 14  SAMA5D22 AHB Bus Matrix (MATRIX1) */
  void* pfnMATRIX0_Handler;                      /* 15  SAMA5D22 AHB Bus Matrix (MATRIX0) */
  void* pfnSECUMOD_Handler;                      /* 16  SAMA5D22 Security Module (SECUMOD) */
  void* pvReserved17;
  void* pfnPIOA_Handler;                         /* 18  SAMA5D22 Parallel Input/Output Controller (PIOA) */
  void* pfnFLEXCOM0_Handler;                     /* 19  SAMA5D22 Flexible Serial Communication (FLEXCOM0) */
  void* pfnFLEXCOM1_Handler;                     /* 20  SAMA5D22 Flexible Serial Communication (FLEXCOM1) */
  void* pvReserved21;
  void* pfnFLEXCOM3_Handler;                     /* 22  SAMA5D22 Flexible Serial Communication (FLEXCOM3) */
  void* pfnFLEXCOM4_Handler;                     /* 23  SAMA5D22 Flexible Serial Communication (FLEXCOM4) */
  void* pfnUART0_Handler;                        /* 24  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART0) */
  void* pfnUART1_Handler;                        /* 25  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART1) */
  void* pfnUART2_Handler;                        /* 26  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART2) */
  void* pfnUART3_Handler;                        /* 27  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART3) */
  void* pfnUART4_Handler;                        /* 28  SAMA5D22 Universal Asynchronous Receiver Transmitter (UART4) */
  void* pfnTWIHS0_Handler;                       /* 29  SAMA5D22 Two-wire Interface High Speed (TWIHS0) */
  void* pfnTWIHS1_Handler;                       /* 30  SAMA5D22 Two-wire Interface High Speed (TWIHS1) */
  void* pvReserved31;
  void* pfnSDMMC1_Handler;                       /* 32  SAMA5D22 Secure Digital MultiMedia Card Controller (SDMMC1) */
  void* pfnSPI0_Handler;                         /* 33  SAMA5D22 Serial Peripheral Interface (SPI0) */
  void* pfnSPI1_Handler;                         /* 34  SAMA5D22 Serial Peripheral Interface (SPI1) */
  void* pfnTC0_Handler;                          /* 35  SAMA5D22 Timer Counter (TC0)   */
  void* pfnTC1_Handler;                          /* 36  SAMA5D22 Timer Counter (TC0)   */
  void* pvReserved37;
  void* pfnPWM_Handler;                          /* 38  SAMA5D22 Pulse Width Modulation Controller (PWM) */
  void* pvReserved39;
  void* pfnADC_Handler;                          /* 40  SAMA5D22 Analog-to-Digital Converter (ADC) */
  void* pvReserved41;
  void* pfnUDPHS_Handler;                        /* 42  SAMA5D22 USB High Speed Device Port (UDPHS) */
  void* pfnSSC0_Handler;                         /* 43  SAMA5D22 Synchronous Serial Controller (SSC0) */
  void* pfnSSC1_Handler;                         /* 44  SAMA5D22 Synchronous Serial Controller (SSC1) */
  void* pfnLCDC_Handler;                         /* 45  SAMA5D22 LCD Controller (LCDC) */
  void* pfnISC_Handler;                          /* 46  SAMA5D22 Image Sensor Controller (ISC) */
  void* pfnTRNG_Handler;                         /* 47  SAMA5D22 True Random Number Generator (TRNG) */
  void* pfnPDMIC_Handler;                        /* 48  SAMA5D22 Pulse Density Modulation Interface Controller (PDMIC) */
  void* pfnAIC_Handler;                          /* 49  SAMA5D22 Advanced Interrupt Controller (AIC) */
  void* pfnSFC_Handler;                          /* 50  SAMA5D22 Secure Fuse Controller (SFC) */
  void* pvReserved51;
  void* pfnQSPI0_Handler;                        /* 52  SAMA5D22 Quad Serial Peripheral Interface (QSPI0) */
  void* pfnQSPI1_Handler;                        /* 53  SAMA5D22 Quad Serial Peripheral Interface (QSPI1) */
  void* pfnI2SC0_Handler;                        /* 54  SAMA5D22 Inter-IC Sound Controller (I2SC0) */
  void* pfnI2SC1_Handler;                        /* 55  SAMA5D22 Inter-IC Sound Controller (I2SC1) */
  void* pfnMCAN0_INT0_Handler;                   /* 56  SAMA5D22 Controller Area Network (MCAN0) */
  void* pvReserved57;
  void* pfnPTC_Handler;                          /* 58  SAMA5D22 Peripheral Touch Controller (PTC) */
  void* pfnCLASSD_Handler;                       /* 59  SAMA5D22 Audio Class D Amplifier (CLASSD) (CLASSD) */
  void* pvReserved60;
  void* pvReserved61;
  void* pvReserved62;
  void* pfnL2CC_Handler;                         /* 63  SAMA5D22 L2 Cache Controller (L2CC) */
  void* pfnMCAN0_INT1_Handler;                   /* 64  SAMA5D22 Controller Area Network (MCAN0) */
  void* pvReserved65;
  void* pfnGMAC_Q1_Handler;                      /* 66  SAMA5D22 Gigabit Ethernet MAC (GMAC) */
  void* pfnGMAC_Q2_Handler;                      /* 67  SAMA5D22 Gigabit Ethernet MAC (GMAC) */
  void* pfnPIOB_Handler;                         /* 68  SAMA5D22 Parallel Input/Output Controller (PIOB) */
  void* pfnPIOC_Handler;                         /* 69  SAMA5D22 Parallel Input/Output Controller (PIOC) */
  void* pfnPIOD_Handler;                         /* 70  SAMA5D22 Parallel Input/Output Controller (PIOD) */
  void* pvReserved71;
  void* pfnSDMMC1_TIMER_Handler;                 /* 72  SAMA5D22 Secure Digital MultiMedia Card Controller (SDMMC1) */
  void* pvReserved73;
  void* pfnSYSC_Handler;                         /* 74  SAMA5D22 Power Management Controller (PMC) */
  void* pfnACC_Handler;                          /* 75  SAMA5D22 Analog Comparator Controller (ACC) */
  void* pfnRXLP_Handler;                         /* 76  SAMA5D22 Low Power Asynchronous Receiver (RXLP) */
} DeviceVectors;
...
/** @}  end of SAMA5D22_cmsis CMSIS Definitions */

/** \defgroup SAMA5D22_api Peripheral Software API
 *  @{
 */
...
/** \defgroup SAMA5D22_reg Registers Access Definitions
 *  @{
 */

/* ************************************************************************** */
/*   REGISTER ACCESS DEFINITIONS FOR SAMA5D22 */
/* ************************************************************************** */
...
/** \addtogroup SAMA5D22_id Peripheral Ids Definitions
 *  @{
 */
