...
#ifndef _SAMV71_USART_COMPONENT_DEPRECATED_H_
#define _SAMV71_USART_COMPONENT_DEPRECATED_H_
...
#define US_CR_RETTO_Msk DEPRECATED(US_CR_RETTO_Msk, "Using deprecated macro US_CR_RETTO_Msk") (_U_(0x1) << US_CR_RETTO_Pos) /**< (US_CR) Start Timeout Immediately Mask */
#define US_CR_RETTO_Pos DEPRECATED(US_CR_RETTO_Pos, "Using deprecated macro US_CR_RETTO_Pos") 15 /**< (US_CR) Start Timeout Immediately Position */
...
#define US_CR_STTTO_Msk DEPRECATED(US_CR_STTTO_Msk, "Using deprecated macro US_CR_STTTO_Msk") (_U_(0x1) << US_CR_STTTO_Pos) /**< (US_CR) Clear TIMEOUT Flag and Start Timeout After Next Character Received Mask */
#define US_CR_STTTO_Pos DEPRECATED(US_CR_STTTO_Pos, "Using deprecated macro US_CR_STTTO_Pos") 11 /**< (US_CR) Clear TIMEOUT Flag and Start Timeout After Next Character Received Position */
...
#define US_CSR_TIMEOUT_Msk DEPRECATED(US_CSR_TIMEOUT_Msk, "Using deprecated macro US_CSR_TIMEOUT_Msk") (_U_(0x1) << US_CSR_TIMEOUT_Pos) /**< (US_CSR) Receiver Timeout (cleared by writing a one to bit US_CR.STTTO) Mask */
#define US_CSR_TIMEOUT_Pos DEPRECATED(US_CSR_TIMEOUT_Pos, "Using deprecated macro US_CSR_TIMEOUT_Pos") 8 /**< (US_CSR) Receiver Timeout (cleared by writing a one to bit US_CR.STTTO) Position */
...
#define US_FIDI_FI_DI_RATIO(value) DEPRECATED(US_FIDI_FI_DI_RATIO(value), "Using deprecated macro US_FIDI_FI_DI_RATIO(value)") (US_FIDI_FI_DI_RATIO_Msk & ((value) << US_FIDI_FI_DI_RATIO_Pos))
...
#define US_IDR_TIMEOUT_Msk DEPRECATED(US_IDR_TIMEOUT_Msk, "Using deprecated macro US_IDR_TIMEOUT_Msk") (_U_(0x1) << US_IDR_TIMEOUT_Pos) /**< (US_IDR) Timeout Interrupt Disable Mask */
#define US_IDR_TIMEOUT_Pos DEPRECATED(US_IDR_TIMEOUT_Pos, "Using deprecated macro US_IDR_TIMEOUT_Pos") 8 /**< (US_IDR) Timeout Interrupt Disable Position */
...
#define US_IER_MANE_Pos DEPRECATED(US_IER_MANE_Pos, "Using deprecated macro US_IER_MANE_Pos") 24 /**< (US_IER) Manchester Error Interrupt Enable Position */
...
#define US_IER_NACK DEPRECATED(US_IER_NACK, "Using deprecated macro US_IER_NACK") US_IER_NACK_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use US_IER_NACK_Msk instead */
...
#define US_IER_TIMEOUT_Msk DEPRECATED(US_IER_TIMEOUT_Msk, "Using deprecated macro US_IER_TIMEOUT_Msk") (_U_(0x1) << US_IER_TIMEOUT_Pos) /**< (US_IER) Timeout Interrupt Enable Mask */
#define US_IER_TIMEOUT_Pos DEPRECATED(US_IER_TIMEOUT_Pos, "Using deprecated macro US_IER_TIMEOUT_Pos") 8 /**< (US_IER) Timeout Interrupt Enable Position */
...
#define US_IMR_TIMEOUT_Msk DEPRECATED(US_IMR_TIMEOUT_Msk, "Using deprecated macro US_IMR_TIMEOUT_Msk") (_U_(0x1) << US_IMR_TIMEOUT_Pos) /**< (US_IMR) Timeout Interrupt Mask Mask */
#define US_IMR_TIMEOUT_Pos DEPRECATED(US_IMR_TIMEOUT_Pos, "Using deprecated macro US_IMR_TIMEOUT_Pos") 8 /**< (US_IMR) Timeout Interrupt Mask Position */
...
#define US_MR_CHMODE_AUTOMATIC DEPRECATED(US_MR_CHMODE_AUTOMATIC, "Using deprecated macro US_MR_CHMODE_AUTOMATIC") (US_MR_CHMODE_AUTOMATIC_Val << US_MR_CHMODE_Pos) /**< (US_MR) Automatic Echo. Receiver input is connected to the TXD pin. Position */
#define US_MR_CHMODE_AUTOMATIC_Val DEPRECATED(US_MR_CHMODE_AUTOMATIC_Val, "Using deprecated macro US_MR_CHMODE_AUTOMATIC_Val") _U_(0x1) /**< (US_MR) Automatic Echo. Receiver input is connected to the TXD pin. */
#define US_MR_CHMODE_LOCAL_LOOPBACK DEPRECATED(US_MR_CHMODE_LOCAL_LOOPBACK, "Using deprecated macro US_MR_CHMODE_LOCAL_LOOPBACK") (US_MR_CHMODE_LOCAL_LOOPBACK_Val << US_MR_CHMODE_Pos) /**< (US_MR) Local Loopback. Transmitter output is connected to the Receiver Input. Position */
#define US_MR_CHMODE_LOCAL_LOOPBACK_Val DEPRECATED(US_MR_CHMODE_LOCAL_LOOPBACK_Val, "Using deprecated macro US_MR_CHMODE_LOCAL_LOOPBACK_Val") _U_(0x2) /**< (US_MR) Local Loopback. Transmitter output is connected to the Receiver Input. */
...
#define US_MR_CHMODE_NORMAL DEPRECATED(US_MR_CHMODE_NORMAL, "Using deprecated macro US_MR_CHMODE_NORMAL") (US_MR_CHMODE_NORMAL_Val << US_MR_CHMODE_Pos) /**< (US_MR) Normal mode Position */
#define US_MR_CHMODE_NORMAL_Val DEPRECATED(US_MR_CHMODE_NORMAL_Val, "Using deprecated macro US_MR_CHMODE_NORMAL_Val") _U_(0x0) /**< (US_MR) Normal mode */
...
#define US_MR_CHMODE_REMOTE_LOOPBACK DEPRECATED(US_MR_CHMODE_REMOTE_LOOPBACK, "Using deprecated macro US_MR_CHMODE_REMOTE_LOOPBACK") (US_MR_CHMODE_REMOTE_LOOPBACK_Val << US_MR_CHMODE_Pos) /**< (US_MR) Remote Loopback. RXD pin is internally connected to the TXD pin. Position */
#define US_MR_CHMODE_REMOTE_LOOPBACK_Val DEPRECATED(US_MR_CHMODE_REMOTE_LOOPBACK_Val, "Using deprecated macro US_MR_CHMODE_REMOTE_LOOPBACK_Val") _U_(0x3) /**< (US_MR) Remote Loopback. RXD pin is internally connected to the TXD pin. */
...
#define US_MR_NBSTOP_1_5_BIT DEPRECATED(US_MR_NBSTOP_1_5_BIT, "Using deprecated macro US_MR_NBSTOP_1_5_BIT") (US_MR_NBSTOP_1_5_BIT_Val << US_MR_NBSTOP_Pos) /**< (US_MR) 1.5 stop bit (SYNC = 0) or reserved (SYNC = 1) Position */
#define US_MR_NBSTOP_1_5_BIT_Val DEPRECATED(US_MR_NBSTOP_1_5_BIT_Val, "Using deprecated macro US_MR_NBSTOP_1_5_BIT_Val") _U_(0x1) /**< (US_MR) 1.5 stop bit (SYNC = 0) or reserved (SYNC = 1) */
#define US_MR_NBSTOP_1_BIT DEPRECATED(US_MR_NBSTOP_1_BIT, "Using deprecated macro US_MR_NBSTOP_1_BIT") (US_MR_NBSTOP_1_BIT_Val << US_MR_NBSTOP_Pos) /**< (US_MR) 1 stop bit Position */
#define US_MR_NBSTOP_1_BIT_Val DEPRECATED(US_MR_NBSTOP_1_BIT_Val, "Using deprecated macro US_MR_NBSTOP_1_BIT_Val") _U_(0x0) /**< (US_MR) 1 stop bit */
#define US_MR_NBSTOP_2_BIT DEPRECATED(US_MR_NBSTOP_2_BIT, "Using deprecated macro US_MR_NBSTOP_2_BIT") (US_MR_NBSTOP_2_BIT_Val << US_MR_NBSTOP_Pos) /**< (US_MR) 2 stop bits Position */
#define US_MR_NBSTOP_2_BIT_Val DEPRECATED(US_MR_NBSTOP_2_BIT_Val, "Using deprecated macro US_MR_NBSTOP_2_BIT_Val") _U_(0x2) /**< (US_MR) 2 stop bits */
...
#define US_MR_PAR_EVEN DEPRECATED(US_MR_PAR_EVEN, "Using deprecated macro US_MR_PAR_EVEN") (US_MR_PAR_EVEN_Val << US_MR_PAR_Pos) /**< (US_MR) Even parity Position */
#define US_MR_PAR_EVEN_Val DEPRECATED(US_MR_PAR_EVEN_Val, "Using deprecated macro US_MR_PAR_EVEN_Val") _U_(0x0) /**< (US_MR) Even parity */
#define US_MR_PAR_MARK DEPRECATED(US_MR_PAR_MARK, "Using deprecated macro US_MR_PAR_MARK") (US_MR_PAR_MARK_Val << US_MR_PAR_Pos) /**< (US_MR) Parity forced to 1 (Mark) Position */
#define US_MR_PAR_MARK_Val DEPRECATED(US_MR_PAR_MARK_Val, "Using deprecated macro US_MR_PAR_MARK_Val") _U_(0x3) /**< (US_MR) Parity forced to 1 (Mark) */
...
#define US_MR_PAR_MULTIDROP DEPRECATED(US_MR_PAR_MULTIDROP, "Using deprecated macro US_MR_PAR_MULTIDROP") (US_MR_PAR_MULTIDROP_Val << US_MR_PAR_Pos) /**< (US_MR) Multidrop mode Position */
#define US_MR_PAR_MULTIDROP_Val DEPRECATED(US_MR_PAR_MULTIDROP_Val, "Using deprecated macro US_MR_PAR_MULTIDROP_Val") _U_(0x6) /**< (US_MR) Multidrop mode */
#define US_MR_PAR_NO DEPRECATED(US_MR_PAR_NO, "Using deprecated macro US_MR_PAR_NO") (US_MR_PAR_NO_Val << US_MR_PAR_Pos) /**< (US_MR) No parity Position */
#define US_MR_PAR_NO_Val DEPRECATED(US_MR_PAR_NO_Val, "Using deprecated macro US_MR_PAR_NO_Val") _U_(0x4) /**< (US_MR) No parity */
#define US_MR_PAR_ODD DEPRECATED(US_MR_PAR_ODD, "Using deprecated macro US_MR_PAR_ODD") (US_MR_PAR_ODD_Val << US_MR_PAR_Pos) /**< (US_MR) Odd parity Position */
#define US_MR_PAR_ODD_Val DEPRECATED(US_MR_PAR_ODD_Val, "Using deprecated macro US_MR_PAR_ODD_Val") _U_(0x1) /**< (US_MR) Odd parity */
#define US_MR_PAR_Pos DEPRECATED(US_MR_PAR_Pos, "Using deprecated macro US_MR_PAR_Pos") 9 /**< (US_MR) Parity Type Position */
#define US_MR_PAR_SPACE DEPRECATED(US_MR_PAR_SPACE, "Using deprecated macro US_MR_PAR_SPACE") (US_MR_PAR_SPACE_Val << US_MR_PAR_Pos) /**< (US_MR) Parity forced to 0 (Space) Position */
#define US_MR_PAR_SPACE_Val DEPRECATED(US_MR_PAR_SPACE_Val, "Using deprecated macro US_MR_PAR_SPACE_Val") _U_(0x2) /**< (US_MR) Parity forced to 0 (Space) */
...
#define US_VERSION_MASK DEPRECATED(US_VERSION_MASK, "Using deprecated macro US_VERSION_MASK") _U_(0x70FFF) /**< \deprecated (US_VERSION) Register MASK (Use US_VERSION_Msk instead) */
#define US_VERSION_MFN_Msk DEPRECATED(US_VERSION_MFN_Msk, "Using deprecated macro US_VERSION_MFN_Msk") (_U_(0x7) << US_VERSION_MFN_Pos) /**< (US_VERSION) Metal Fix Number Mask */
#define US_VERSION_MFN_Pos DEPRECATED(US_VERSION_MFN_Pos, "Using deprecated macro US_VERSION_MFN_Pos") 16 /**< (US_VERSION) Metal Fix Number Position */
#define US_VERSION_MFN(value) DEPRECATED(US_VERSION_MFN, "Using deprecated macro US_VERSION_MFN") (US_VERSION_MFN_Msk & ((value) << US_VERSION_MFN_Pos))
#define US_VERSION_Msk DEPRECATED(US_VERSION_Msk, "Using deprecated macro US_VERSION_Msk") _U_(0x70FFF) /**< (US_VERSION) Register Mask */
#define US_VERSION_OFFSET DEPRECATED(US_VERSION_OFFSET, "Using deprecated macro US_VERSION_OFFSET") (0xFC) /**< (US_VERSION) Version Register Offset */
#define US_VERSION_VERSION_Msk DEPRECATED(US_VERSION_VERSION_Msk, "Using deprecated macro US_VERSION_VERSION_Msk") (_U_(0xFFF) << US_VERSION_VERSION_Pos) /**< (US_VERSION) Hardware Module Version Mask */
#define US_VERSION_VERSION_Pos DEPRECATED(US_VERSION_VERSION_Pos, "Using deprecated macro US_VERSION_VERSION_Pos") 0 /**< (US_VERSION) Hardware Module Version Position */
#define US_VERSION_VERSION(value) DEPRECATED(US_VERSION_VERSION, "Using deprecated macro US_VERSION_VERSION") (US_VERSION_VERSION_Msk & ((value) << US_VERSION_VERSION_Pos))
