 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for PIC32CK2051SG01064
 *
...
void TCC0_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC0_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC0_MC_2_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC0_MC_3_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC0_MC_4_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC0_MC_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC1_OTHER_Handler        ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC1_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC1_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC1_MC_2_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC1_MC_3_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC1_MC_4_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC1_MC_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC2_OTHER_Handler        ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC2_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC2_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC2_MC_2_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC2_MC_3_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC2_MC_4_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC2_MC_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC3_OTHER_Handler        ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC3_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC3_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC3_MC_2_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC3_MC_3_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC3_MC_4_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC3_MC_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void TCC4_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC4_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC5_OTHER_Handler        ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC5_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC5_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC6_OTHER_Handler        ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC6_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC6_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC7_OTHER_Handler        ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC7_MC_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void TCC7_MC_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void ADC_0_Handler             ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void ADC_1_Handler             ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void ADC_2_Handler             ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void ADC_3_Handler             ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void ADC_4_Handler             ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void ADC_5_Handler             ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void HSM_ERROR_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
const DeviceVectors exception_table=
{
        ...
        /* .pfnTCC0_MC_0_Handler    = */ (void*) TCC0_MC_0_Handler,   /* 69 Timer Counter for Control Applications */
        /* .pfnTCC0_MC_1_Handler    = */ (void*) TCC0_MC_1_Handler,   /* 70 Timer Counter for Control Applications */
        /* .pfnTCC0_MC_2_Handler    = */ (void*) TCC0_MC_2_Handler,   /* 71 Timer Counter for Control Applications */
        /* .pfnTCC0_MC_3_Handler    = */ (void*) TCC0_MC_3_Handler,   /* 72 Timer Counter for Control Applications */
        /* .pfnTCC0_MC_4_Handler    = */ (void*) TCC0_MC_4_Handler,   /* 73 Timer Counter for Control Applications */
        /* .pfnTCC0_MC_5_Handler    = */ (void*) TCC0_MC_5_Handler,   /* 74 Timer Counter for Control Applications */
        /* .pfnTCC1_OTHER_Handler   = */ (void*) TCC1_OTHER_Handler,  /* 75 Timer Counter for Control Applications */
        /* .pfnTCC1_MC_0_Handler    = */ (void*) TCC1_MC_0_Handler,   /* 76 Timer Counter for Control Applications */
        /* .pfnTCC1_MC_1_Handler    = */ (void*) TCC1_MC_1_Handler,   /* 77 Timer Counter for Control Applications */
        /* .pfnTCC1_MC_2_Handler    = */ (void*) TCC1_MC_2_Handler,   /* 78 Timer Counter for Control Applications */
        /* .pfnTCC1_MC_3_Handler    = */ (void*) TCC1_MC_3_Handler,   /* 79 Timer Counter for Control Applications */
        /* .pfnTCC1_MC_4_Handler    = */ (void*) TCC1_MC_4_Handler,   /* 80 Timer Counter for Control Applications */
        /* .pfnTCC1_MC_5_Handler    = */ (void*) TCC1_MC_5_Handler,   /* 81 Timer Counter for Control Applications */
        /* .pfnTCC2_OTHER_Handler   = */ (void*) TCC2_OTHER_Handler,  /* 82 Timer Counter for Control Applications */
        /* .pfnTCC2_MC_0_Handler    = */ (void*) TCC2_MC_0_Handler,   /* 83 Timer Counter for Control Applications */
        /* .pfnTCC2_MC_1_Handler    = */ (void*) TCC2_MC_1_Handler,   /* 84 Timer Counter for Control Applications */
        /* .pfnTCC2_MC_2_Handler    = */ (void*) TCC2_MC_2_Handler,   /* 85 Timer Counter for Control Applications */
        /* .pfnTCC2_MC_3_Handler    = */ (void*) TCC2_MC_3_Handler,   /* 86 Timer Counter for Control Applications */
        /* .pfnTCC2_MC_4_Handler    = */ (void*) TCC2_MC_4_Handler,   /* 87 Timer Counter for Control Applications */
        /* .pfnTCC2_MC_5_Handler    = */ (void*) TCC2_MC_5_Handler,   /* 88 Timer Counter for Control Applications */
        /* .pfnTCC3_OTHER_Handler   = */ (void*) TCC3_OTHER_Handler,  /* 89 Timer Counter for Control Applications */
        /* .pfnTCC3_MC_0_Handler    = */ (void*) TCC3_MC_0_Handler,   /* 90 Timer Counter for Control Applications */
        /* .pfnTCC3_MC_1_Handler    = */ (void*) TCC3_MC_1_Handler,   /* 91 Timer Counter for Control Applications */
        /* .pfnTCC3_MC_2_Handler    = */ (void*) TCC3_MC_2_Handler,   /* 92 Timer Counter for Control Applications */
        /* .pfnTCC3_MC_3_Handler    = */ (void*) TCC3_MC_3_Handler,   /* 93 Timer Counter for Control Applications */
        /* .pfnTCC3_MC_4_Handler    = */ (void*) TCC3_MC_4_Handler,   /* 94 Timer Counter for Control Applications */
        /* .pfnTCC3_MC_5_Handler    = */ (void*) TCC3_MC_5_Handler,   /* 95 Timer Counter for Control Applications */
        ...
        /* .pfnTCC4_MC_0_Handler    = */ (void*) TCC4_MC_0_Handler,   /* 121 Timer Counter for Control Applications */
        /* .pfnTCC4_MC_1_Handler    = */ (void*) TCC4_MC_1_Handler,   /* 122 Timer Counter for Control Applications */
        /* .pfnTCC5_OTHER_Handler   = */ (void*) TCC5_OTHER_Handler,  /* 123 Timer Counter for Control Applications */
        /* .pfnTCC5_MC_0_Handler    = */ (void*) TCC5_MC_0_Handler,   /* 124 Timer Counter for Control Applications */
        /* .pfnTCC5_MC_1_Handler    = */ (void*) TCC5_MC_1_Handler,   /* 125 Timer Counter for Control Applications */
        /* .pfnTCC6_OTHER_Handler   = */ (void*) TCC6_OTHER_Handler,  /* 126 Timer Counter for Control Applications */
        /* .pfnTCC6_MC_0_Handler    = */ (void*) TCC6_MC_0_Handler,   /* 127 Timer Counter for Control Applications */
        /* .pfnTCC6_MC_1_Handler    = */ (void*) TCC6_MC_1_Handler,   /* 128 Timer Counter for Control Applications */
        /* .pfnTCC7_OTHER_Handler   = */ (void*) TCC7_OTHER_Handler,  /* 129 Timer Counter for Control Applications */
        /* .pfnTCC7_MC_0_Handler    = */ (void*) TCC7_MC_0_Handler,   /* 130 Timer Counter for Control Applications */
        /* .pfnTCC7_MC_1_Handler    = */ (void*) TCC7_MC_1_Handler,   /* 131 Timer Counter for Control Applications */
        /* .pfnADC_0_Handler        = */ (void*) ADC_0_Handler,       /* 132 ADC Controller */
        /* .pfnADC_1_Handler        = */ (void*) ADC_1_Handler,       /* 133 ADC Controller */
        /* .pfnADC_2_Handler        = */ (void*) ADC_2_Handler,       /* 134 ADC Controller */
        /* .pfnADC_3_Handler        = */ (void*) ADC_3_Handler,       /* 135 ADC Controller */
        /* .pfnADC_4_Handler        = */ (void*) ADC_4_Handler,       /* 136 ADC Controller */
        /* .pfnADC_5_Handler        = */ (void*) ADC_5_Handler,       /* 137 ADC Controller */
        ...
        /* .pfnHSM_ERROR_Handler    = */ (void*) HSM_ERROR_Handler,   /* 155 Hardware Security Module */
        /* .pfnHSM_TXINT_Handler    = */ (void*) HSM_TXINT_Handler,   /* 156 Hardware Security Module */
        /* .pfnHSM_RXINT_Handler    = */ (void*) HSM_RXINT_Handler    /* 157 Hardware Security Module */

#else /* Legacy defined(_32CK2051SG01064_H) */
