 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for PIC32CZ2051CA91144
 *
...
void SERCOM4_6_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM4_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void SERCOM5_6_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM5_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void CAN2_Handler              ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void CAN3_Handler              ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
#else /* Legacy defined(_32CZ2051CA91144_H) */
