...
#define _SAMA5D2_TC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Timer Counter
 *  @{
 */
/* ========================================================================== */
...
#define REV_TC ZO                     /**< (TC) Module revision */
...
#define   TC_CMR_WAVEFORM_EEVTEDG_EDGE_Val  _U_(0x3)                                       /**< (TC_CMR) WAVEFORM Each edge  */
...
#define TC_SR_OFFSET                        (0x20)                                        /**<  (TC_SR) Interrupt Status Register  Offset */
...
#define TC_IMR_ETRGS_Pos                    7                                              /**< (TC_IMR)  Position */
...
#define TC_EMR_OFFSET                       (0x30)                                        /**<  (TC_EMR) Extended Mode Register  Offset */
...
typedef struct {  
  __O  uint32_t TC_CCR;         /**< (TC_CHANNEL Offset: 0x00) Channel Control Register */
  __IO uint32_t TC_CMR;         /**< (TC_CHANNEL Offset: 0x04) Channel Mode Register */
  __IO uint32_t TC_SMMR;        /**< (TC_CHANNEL Offset: 0x08) Stepper Motor Mode Register */
  __I  uint32_t TC_RAB;         /**< (TC_CHANNEL Offset: 0x0C) Register AB */
  __I  uint32_t TC_CV;          /**< (TC_CHANNEL Offset: 0x10) Counter Value */
  __IO uint32_t TC_RA;          /**< (TC_CHANNEL Offset: 0x14) Register A */
  __IO uint32_t TC_RB;          /**< (TC_CHANNEL Offset: 0x18) Register B */
  __IO uint32_t TC_RC;          /**< (TC_CHANNEL Offset: 0x1C) Register C */
  __I  uint32_t TC_SR;          /**< (TC_CHANNEL Offset: 0x20) Interrupt Status Register */
  __O  uint32_t TC_IER;         /**< (TC_CHANNEL Offset: 0x24) Interrupt Enable Register */
  __O  uint32_t TC_IDR;         /**< (TC_CHANNEL Offset: 0x28) Interrupt Disable Register */
  __I  uint32_t TC_IMR;         /**< (TC_CHANNEL Offset: 0x2C) Interrupt Mask Register */
  __IO uint32_t TC_EMR;         /**< (TC_CHANNEL Offset: 0x30) Extended Mode Register */
...
typedef struct {  
       TcChannel TcChannel[TCCHANNEL_NUMBER]; /**< Offset: 0x00  */
...
/** \brief TC_CHANNEL hardware registers */
typedef struct {  
  __O  TC_CCR_Type                    TC_CCR;         /**< Offset: 0x00 ( /W  32) Channel Control Register */
  __IO TC_CMR_Type                    TC_CMR;         /**< Offset: 0x04 (R/W  32) Channel Mode Register */
  __IO TC_SMMR_Type                   TC_SMMR;        /**< Offset: 0x08 (R/W  32) Stepper Motor Mode Register */
  __I  TC_RAB_Type                    TC_RAB;         /**< Offset: 0x0C (R/   32) Register AB */
  __I  TC_CV_Type                     TC_CV;          /**< Offset: 0x10 (R/   32) Counter Value */
  __IO TC_RA_Type                     TC_RA;          /**< Offset: 0x14 (R/W  32) Register A */
  __IO TC_RB_Type                     TC_RB;          /**< Offset: 0x18 (R/W  32) Register B */
  __IO TC_RC_Type                     TC_RC;          /**< Offset: 0x1C (R/W  32) Register C */
  __I  TC_SR_Type                     TC_SR;          /**< Offset: 0x20 (R/   32) Interrupt Status Register */
  __O  TC_IER_Type                    TC_IER;         /**< Offset: 0x24 ( /W  32) Interrupt Enable Register */
  __O  TC_IDR_Type                    TC_IDR;         /**< Offset: 0x28 ( /W  32) Interrupt Disable Register */
  __I  TC_IMR_Type                    TC_IMR;         /**< Offset: 0x2C (R/   32) Interrupt Mask Register */
  __IO TC_EMR_Type                    TC_EMR;         /**< Offset: 0x30 (R/W  32) Extended Mode Register */
  __I  uint8_t                        Reserved1[12];
} TcChannel;

/** \brief TC hardware registers */
typedef struct {  
       TcChannel                      TcChannel[3];   /**< Offset: 0x00  */
