...
def check_config():
    ...
    try:
        ...
        message = "The global varaible(dictionary) \'g_mpu_config\' needs to be defined in \'autoload.py\' for MPU projects"
    else:
        ...
        if g_mpu_config['type'] == 'bootsrap' and not 'entry_addr' in g_mpu_config.keys():
