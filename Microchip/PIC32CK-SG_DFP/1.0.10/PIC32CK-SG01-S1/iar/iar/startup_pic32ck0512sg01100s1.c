 ...
 * \file
 *
 * \brief IAR startup file for PIC32CK0512SG01100S1
 *
...
#pragma weak CSM_COMMANDCANCEL_Handler=Dummy_Handler
#pragma weak INTCTRL_Handler=Dummy_Handler
#pragma weak CSM_FCW_Handler=Dummy_Handler
