 ...
 * $Revision:    V1.0.1
 *
 * Project:      Flash Programming Functions for ATSAMR30
 * --------------------------------------------------------------------------- */
...
typedef struct {
  vu32 INTENCLR;        /* offset: 0x00 (R/W 32) Interrupt Enable Clear Register */
  vu32 INTENSET;        /* offset: 0x04 (R/W 32) Interrupt Enable Set Register */
  vu32 INTFLAG;         /* offset: 0x08 (R/W 32) Interrupt Flag Status and Clear Register */
  vu32 STATUS;          /* offset: 0x0C (R/  32) Power and Clocks Status Register */
  vu16 XOSCCTRL;        /* offset: 0x10 (R/W 16) External Multipurpose Crystal Oscillator (XOSC) Control Register */
  vu8  RESERVED1[0x2];
  vu8  OSC16MCTRL;      /* offset: 0x14 (R/W  8) 16MHz Internal Oscillator (OSC16M) Control Register */
  /* ignore following registers */
} OSCCTRL_TypeDef;
...
/* ---- SAM R30 ------------------------------------------------------------------*/
#if defined ATSAMR30_256
  #define PAC_BASE             0x44000000
  #define NVMCTRL_BASE         0x41004000              /* SAMR30 */
  #define OSCCTRL_BASE         0x40000C00              /* SAMR30 */
#endif
 ...
 */
  ...
  PAC->WRCTRL = (( 1ul << 16) |       /* disable OSCCTRL Write Protection */
                 ( 3ul <<  0) );
  OSCCTRL->OSC16MCTRL |= (3ul << 2);
 ...
 */
#ifdef FLASH_MEM
/* currently we write up to 4 pages at a time
