 ...
 * \file
 *
 * \brief Header file for SAMC20N18A
 *
 ...
 * \addtogroup SAMC20N18A_definitions SAMC20N18A definitions
...
/* ************************************************************************** */
/** \defgroup SAMC20N18A_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  SYSTEM_IRQn              =  0, /**<  0 SAMC20N18A System Interrupts */
  WDT_IRQn                 =  1, /**<  1 SAMC20N18A Watchdog Timer (WDT) */
  RTC_IRQn                 =  2, /**<  2 SAMC20N18A Real-Time Counter (RTC) */
  EIC_IRQn                 =  3, /**<  3 SAMC20N18A External Interrupt Controller (EIC) */
  FREQM_IRQn               =  4, /**<  4 SAMC20N18A Frequency Meter (FREQM) */
  NVMCTRL_IRQn             =  6, /**<  6 SAMC20N18A Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  7, /**<  7 SAMC20N18A Direct Memory Access Controller (DMAC) */
  EVSYS_IRQn               =  8, /**<  8 SAMC20N18A Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMC20N18A Serial Communication Interface 0 (SERCOM0) */
  SERCOM6_IRQn             =  9, /**<  9 SAMC20N18A Serial Communication Interface 6 (SERCOM6) */
  SERCOM1_IRQn             = 10, /**< 10 SAMC20N18A Serial Communication Interface 1 (SERCOM1) */
  SERCOM7_IRQn             = 10, /**< 10 SAMC20N18A Serial Communication Interface 7 (SERCOM7) */
  SERCOM2_IRQn             = 11, /**< 11 SAMC20N18A Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMC20N18A Serial Communication Interface 3 (SERCOM3) */
  SERCOM4_IRQn             = 13, /**< 13 SAMC20N18A Serial Communication Interface 4 (SERCOM4) */
  SERCOM5_IRQn             = 14, /**< 14 SAMC20N18A Serial Communication Interface 5 (SERCOM5) */
  TCC0_IRQn                = 17, /**< 17 SAMC20N18A Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 18, /**< 18 SAMC20N18A Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 19, /**< 19 SAMC20N18A Timer Counter Control 2 (TCC2) */
  TC0_IRQn                 = 20, /**< 20 SAMC20N18A Basic Timer Counter 0 (TC0) */
  TC5_IRQn                 = 20, /**< 20 SAMC20N18A Basic Timer Counter 5 (TC5) */
  TC1_IRQn                 = 21, /**< 21 SAMC20N18A Basic Timer Counter 1 (TC1) */
  TC6_IRQn                 = 21, /**< 21 SAMC20N18A Basic Timer Counter 6 (TC6) */
  TC2_IRQn                 = 22, /**< 22 SAMC20N18A Basic Timer Counter 2 (TC2) */
  TC7_IRQn                 = 22, /**< 22 SAMC20N18A Basic Timer Counter 7 (TC7) */
  TC3_IRQn                 = 23, /**< 23 SAMC20N18A Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 24, /**< 24 SAMC20N18A Basic Timer Counter 4 (TC4) */
  ADC0_IRQn                = 25, /**< 25 SAMC20N18A Analog Digital Converter 0 (ADC0) */
  AC_IRQn                  = 27, /**< 27 SAMC20N18A Analog Comparators (AC) */
  PTC_IRQn                 = 30, /**< 30 SAMC20N18A Peripheral Touch Controller (PTC) */
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAMC20N18A */
/* ************************************************************************** */
/** \defgroup SAMC20N18A_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMC20N18A */
/* ************************************************************************** */
/** \defgroup SAMC20N18A_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMC20N18A_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMC20N18A_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMC20N18A */
/* ************************************************************************** */
/** \defgroup SAMC20N18A_port PORT Definitions */
/*@{*/
...
#define DSU_DID_RESETVALUE    _UL_(0x11001420)
#define AC_PAIRS              2
