 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for PIC32CZ8110CA80208
 *
...
void SERCOM6_6_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM6_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void SERCOM7_6_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM7_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void SERCOM8_6_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM8_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM8_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM8_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM8_2_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM8_3_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM8_4_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM9_6_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM9_5_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM9_0_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM9_1_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM9_2_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM9_3_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void SERCOM9_4_Handler         ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void SPI_IXS1_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void CAN4_Handler              ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void CAN5_Handler              ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void SQI1_Handler              ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
void USBHS1_Handler            ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved215_Handler       ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved216_Handler       ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void Reserved217_Handler       ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
const DeviceVectors exception_table=
{
        ...
        /* .pvReserved215           = */ (void*) (0UL),               /* 215 Reserved */
        /* .pvReserved216           = */ (void*) (0UL),               /* 216 Reserved */
        /* .pvReserved217           = */ (void*) (0UL),               /* 217 Reserved */
...
#else /* Legacy defined(_32CZ8110CA80208_H) */
