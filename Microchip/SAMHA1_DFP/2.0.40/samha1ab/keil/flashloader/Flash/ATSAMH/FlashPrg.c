 ...
 * $Revision:    V1.0.0
 *
 * Project:      Flash Programming Functions for ATSAMH
 * --------------------------------------------------------------------------- */
...
/* ---- SAM H ------------------------------------------------------------------*/
#if defined ATSAMH_64 || defined ATSAMH_32 || defined ATSAMH_16
  #define PAC0_BASE            0x40000000
  #define PAC1_BASE            0x41000000
  #define NVMCTRL_BASE         0x41004000
#endif

#if defined ATSAMH_64
  #define FLASH_SIZE           0x10000
#endif

#if defined ATSAMH_32
  #define FLASH_SIZE           0x08000
#endif

#if defined ATSAMH_16
