 ...
 * \file
 *
 * \brief MPLAB(R) XC32 - Startup code for PIC32CX1012BZ24032
 *
...
void ADC_EOS_Handler           ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
const DeviceVectors exception_table=
{
        ...
        /* .pfnADC_EOS_Handler      = */ (void*) ADC_EOS_Handler,     /* 35 12-bit Analog to Digital Converter */
...
#else /* Legacy defined(_32CX1012BZ24032_H) */
