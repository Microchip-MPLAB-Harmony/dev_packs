...
#define _SAMA5D2_XDMAC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Extensible DMA Controller
 *  @{
 */
/* ========================================================================== */
...
#define REV_XDMAC M                      /**< (XDMAC) Module revision */
...
typedef union { 
  struct {
    ...
    uint32_t PROT:1;                    /**< bit:      5  Channel x Protection                     */
...
#define XDMAC_CC_PROT_Pos                   5                                              /**< (XDMAC_CC) Channel x Protection Position */
#define XDMAC_CC_PROT_Msk                   (_U_(0x1) << XDMAC_CC_PROT_Pos)                /**< (XDMAC_CC) Channel x Protection Mask */
#define XDMAC_CC_PROT                       XDMAC_CC_PROT_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use XDMAC_CC_PROT_Msk instead */
...
#define XDMAC_CC_MASK                       _U_(0x7FEF7FF7)                                /**< \deprecated (XDMAC_CC) Register MASK  (Use XDMAC_CC_Msk instead)  */
...
typedef union { 
  ...
  struct {
    uint32_t IE:16;                     /**< bit:  0..15  XDMAC Channel x5 Interrupt Enable Bit    */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
...
#define XDMAC_GIE_MASK                      _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GIE) Register MASK  (Use XDMAC_GIE_Msk instead)  */
#define XDMAC_GIE_Msk                       _U_(0xFFFF)                                    /**< (XDMAC_GIE) Register Mask  */

#define XDMAC_GIE_IE_Pos                    0                                              /**< (XDMAC_GIE Position) XDMAC Channel x5 Interrupt Enable Bit */
...
typedef union { 
  ...
  struct {
    uint32_t ID:16;                     /**< bit:  0..15  XDMAC Channel x5 Interrupt Disable Bit   */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GID_Type;
...
#define XDMAC_GID_MASK                      _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GID) Register MASK  (Use XDMAC_GID_Msk instead)  */
#define XDMAC_GID_Msk                       _U_(0xFFFF)                                    /**< (XDMAC_GID) Register Mask  */

#define XDMAC_GID_ID_Pos                    0                                              /**< (XDMAC_GID Position) XDMAC Channel x5 Interrupt Disable Bit */
...
typedef union { 
  ...
  struct {
    uint32_t IM:16;                     /**< bit:  0..15  XDMAC Channel x5 Interrupt Mask Bit      */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GIM_Type;
...
#define XDMAC_GIM_MASK                      _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GIM) Register MASK  (Use XDMAC_GIM_Msk instead)  */
#define XDMAC_GIM_Msk                       _U_(0xFFFF)                                    /**< (XDMAC_GIM) Register Mask  */

#define XDMAC_GIM_IM_Pos                    0                                              /**< (XDMAC_GIM Position) XDMAC Channel x5 Interrupt Mask Bit */
...
typedef union { 
  ...
  struct {
    uint32_t IS:16;                     /**< bit:  0..15  XDMAC Channel x5 Interrupt Status Bit    */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GIS_Type;
...
#define XDMAC_GIS_MASK                      _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GIS) Register MASK  (Use XDMAC_GIS_Msk instead)  */
#define XDMAC_GIS_Msk                       _U_(0xFFFF)                                    /**< (XDMAC_GIS) Register Mask  */

#define XDMAC_GIS_IS_Pos                    0                                              /**< (XDMAC_GIS Position) XDMAC Channel x5 Interrupt Status Bit */
...
typedef union { 
  ...
  struct {
    uint32_t EN:16;                     /**< bit:  0..15  XDMAC Channel x5 Enable Bit              */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GE_Type;
...
#define XDMAC_GE_MASK                       _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GE) Register MASK  (Use XDMAC_GE_Msk instead)  */
#define XDMAC_GE_Msk                        _U_(0xFFFF)                                    /**< (XDMAC_GE) Register Mask  */

#define XDMAC_GE_EN_Pos                     0                                              /**< (XDMAC_GE Position) XDMAC Channel x5 Enable Bit */
...
typedef union { 
  ...
  struct {
    uint32_t DI:16;                     /**< bit:  0..15  XDMAC Channel x5 Disable Bit             */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GD_Type;
...
#define XDMAC_GD_MASK                       _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GD) Register MASK  (Use XDMAC_GD_Msk instead)  */
#define XDMAC_GD_Msk                        _U_(0xFFFF)                                    /**< (XDMAC_GD) Register Mask  */

#define XDMAC_GD_DI_Pos                     0                                              /**< (XDMAC_GD Position) XDMAC Channel x5 Disable Bit */
...
typedef union { 
  ...
  struct {
    uint32_t ST:16;                     /**< bit:  0..15  XDMAC Channel x5 Status Bit              */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GS_Type;
...
#define XDMAC_GS_MASK                       _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GS) Register MASK  (Use XDMAC_GS_Msk instead)  */
#define XDMAC_GS_Msk                        _U_(0xFFFF)                                    /**< (XDMAC_GS) Register Mask  */

#define XDMAC_GS_ST_Pos                     0                                              /**< (XDMAC_GS Position) XDMAC Channel x5 Status Bit */
...
typedef union { 
  ...
  struct {
    uint32_t RS:16;                     /**< bit:  0..15  XDMAC Channel x5 Read Suspend Bit        */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GRS_Type;
...
#define XDMAC_GRS_MASK                      _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GRS) Register MASK  (Use XDMAC_GRS_Msk instead)  */
#define XDMAC_GRS_Msk                       _U_(0xFFFF)                                    /**< (XDMAC_GRS) Register Mask  */

#define XDMAC_GRS_RS_Pos                    0                                              /**< (XDMAC_GRS Position) XDMAC Channel x5 Read Suspend Bit */
...
typedef union { 
  ...
  struct {
    uint32_t WS:16;                     /**< bit:  0..15  XDMAC Channel x5 Write Suspend Bit       */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GWS_Type;
...
#define XDMAC_GWS_MASK                      _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GWS) Register MASK  (Use XDMAC_GWS_Msk instead)  */
#define XDMAC_GWS_Msk                       _U_(0xFFFF)                                    /**< (XDMAC_GWS) Register Mask  */

#define XDMAC_GWS_WS_Pos                    0                                              /**< (XDMAC_GWS Position) XDMAC Channel x5 Write Suspend Bit */
...
typedef union { 
  ...
  struct {
    uint32_t RWS:16;                    /**< bit:  0..15  XDMAC Channel x5 Read Write Suspend Bit  */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GRWS_Type;
...
#define XDMAC_GRWS_MASK                     _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GRWS) Register MASK  (Use XDMAC_GRWS_Msk instead)  */
#define XDMAC_GRWS_Msk                      _U_(0xFFFF)                                    /**< (XDMAC_GRWS) Register Mask  */

#define XDMAC_GRWS_RWS_Pos                  0                                              /**< (XDMAC_GRWS Position) XDMAC Channel x5 Read Write Suspend Bit */
...
typedef union { 
  ...
  struct {
    uint32_t RWR:16;                    /**< bit:  0..15  XDMAC Channel x5 Read Write Resume Bit   */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GRWR_Type;
...
#define XDMAC_GRWR_MASK                     _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GRWR) Register MASK  (Use XDMAC_GRWR_Msk instead)  */
#define XDMAC_GRWR_Msk                      _U_(0xFFFF)                                    /**< (XDMAC_GRWR) Register Mask  */

#define XDMAC_GRWR_RWR_Pos                  0                                              /**< (XDMAC_GRWR Position) XDMAC Channel x5 Read Write Resume Bit */
...
typedef union { 
  ...
  struct {
    uint32_t SWREQ:16;                  /**< bit:  0..15  XDMAC Channel x5 Software Request Bit    */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GSWR_Type;
...
#define XDMAC_GSWR_MASK                     _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GSWR) Register MASK  (Use XDMAC_GSWR_Msk instead)  */
#define XDMAC_GSWR_Msk                      _U_(0xFFFF)                                    /**< (XDMAC_GSWR) Register Mask  */

#define XDMAC_GSWR_SWREQ_Pos                0                                              /**< (XDMAC_GSWR Position) XDMAC Channel x5 Software Request Bit */
...
typedef union { 
  ...
  struct {
    uint32_t SWRS:16;                   /**< bit:  0..15  XDMAC Channel x5 Software Request Status Bit */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GSWS_Type;
...
#define XDMAC_GSWS_MASK                     _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GSWS) Register MASK  (Use XDMAC_GSWS_Msk instead)  */
#define XDMAC_GSWS_Msk                      _U_(0xFFFF)                                    /**< (XDMAC_GSWS) Register Mask  */

#define XDMAC_GSWS_SWRS_Pos                 0                                              /**< (XDMAC_GSWS Position) XDMAC Channel x5 Software Request Status Bit */
...
typedef union { 
  ...
  struct {
    uint32_t SWF:16;                    /**< bit:  0..15  XDMAC Channel x5 Software Flush Request Bit */
    uint32_t :16;                       /**< bit: 16..31 Reserved */
  } vec;                                /**< Structure used for vec  access  */
  uint32_t reg;                         /**< Type used for register access */
} XDMAC_GSWF_Type;
...
#define XDMAC_GSWF_MASK                     _U_(0xFFFF)                                    /**< \deprecated (XDMAC_GSWF) Register MASK  (Use XDMAC_GSWF_Msk instead)  */
#define XDMAC_GSWF_Msk                      _U_(0xFFFF)                                    /**< (XDMAC_GSWF) Register Mask  */

#define XDMAC_GSWF_SWF_Pos                  0                                              /**< (XDMAC_GSWF Position) XDMAC Channel x5 Software Flush Request Bit */
...
typedef struct {  
  ...
  __I  uint8_t                        Reserved1[12];
       XdmacChid XdmacChid[XDMACCHID_NUMBER]; /**< Offset: 0x50 Channel Intterupt Enable Register */
} Xdmac;
...
typedef struct {  
  ...
  __I  uint8_t                        Reserved1[12];
       XdmacChid                      XdmacChid[16];  /**< Offset: 0x50 Channel Intterupt Enable Register */
} Xdmac;
