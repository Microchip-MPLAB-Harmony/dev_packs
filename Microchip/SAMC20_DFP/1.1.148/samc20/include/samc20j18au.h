 ...
 * \file
 *
 * \brief Header file for SAMC20J18AU
 *
...
#ifndef _SAMC20J18AU_
#define _SAMC20J18AU_

/**
 * \ingroup SAMC20_definitions
 * \addtogroup SAMC20J18AU_definitions SAMC20J18AU definitions
...
/* ************************************************************************** */
/** \defgroup SAMC20J18AU_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  SYSTEM_IRQn              =  0, /**<  0 SAMC20J18AU System Interrupts */
  WDT_IRQn                 =  1, /**<  1 SAMC20J18AU Watchdog Timer (WDT) */
  RTC_IRQn                 =  2, /**<  2 SAMC20J18AU Real-Time Counter (RTC) */
  EIC_IRQn                 =  3, /**<  3 SAMC20J18AU External Interrupt Controller (EIC) */
  FREQM_IRQn               =  4, /**<  4 SAMC20J18AU Frequency Meter (FREQM) */
  NVMCTRL_IRQn             =  6, /**<  6 SAMC20J18AU Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  7, /**<  7 SAMC20J18AU Direct Memory Access Controller (DMAC) */
  EVSYS_IRQn               =  8, /**<  8 SAMC20J18AU Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMC20J18AU Serial Communication Interface 0 (SERCOM0) */
  SERCOM1_IRQn             = 10, /**< 10 SAMC20J18AU Serial Communication Interface 1 (SERCOM1) */
  SERCOM2_IRQn             = 11, /**< 11 SAMC20J18AU Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMC20J18AU Serial Communication Interface 3 (SERCOM3) */
  TCC0_IRQn                = 17, /**< 17 SAMC20J18AU Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 18, /**< 18 SAMC20J18AU Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 19, /**< 19 SAMC20J18AU Timer Counter Control 2 (TCC2) */
  TC0_IRQn                 = 20, /**< 20 SAMC20J18AU Basic Timer Counter 0 (TC0) */
  TC1_IRQn                 = 21, /**< 21 SAMC20J18AU Basic Timer Counter 1 (TC1) */
  TC2_IRQn                 = 22, /**< 22 SAMC20J18AU Basic Timer Counter 2 (TC2) */
  TC3_IRQn                 = 23, /**< 23 SAMC20J18AU Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 24, /**< 24 SAMC20J18AU Basic Timer Counter 4 (TC4) */
  ADC0_IRQn                = 25, /**< 25 SAMC20J18AU Analog Digital Converter 0 (ADC0) */
  AC_IRQn                  = 27, /**< 27 SAMC20J18AU Analog Comparators (AC) */
  PTC_IRQn                 = 30, /**< 30 SAMC20J18AU Peripheral Touch Controller (PTC) */
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAMC20J18AU */
/* ************************************************************************** */
/** \defgroup SAMC20J18AU_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMC20J18AU */
/* ************************************************************************** */
/** \defgroup SAMC20J18AU_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMC20J18AU_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMC20J18AU_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMC20J18AU */
/* ************************************************************************** */
/** \defgroup SAMC20J18AU_port PORT Definitions */
/*@{*/
...
#define DSU_DID_RESETVALUE    _UL_(0x1100050F)
#define AC_PAIRS              1
