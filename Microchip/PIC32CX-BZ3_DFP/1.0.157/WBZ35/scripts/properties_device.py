...
def header_copyright():
    print("Header GUI v1.13 (c) 2/14/2023 Microchip Technology All Rights Reserved")
    
def ota_copyright():
    print("Over The Air Package Maker GUI v1.10 (c) 2/13/2023 Microchip Technology All Rights Reserved")
