...
#define _SAMA5D2_RSTC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Reset Controller
 *  @{
 */
/* ========================================================================== */
...
#define RSTC_11265                      /**< (RSTC) Module ID */
#define REV_RSTC C                      /**< (RSTC) Module revision */
...
#define RSTC_CR_KEY_Pos                     24                                             /**< (RSTC_CR) Write Access Password Position */
...
#define RSTC_CR_MASK                        _U_(0xFF000001)                                /**< \deprecated (RSTC_CR) Register MASK  (Use RSTC_CR_Msk instead)  */
...
#define RSTC_MR_MASK                        _U_(0xFF000011)                                /**< \deprecated (RSTC_MR) Register MASK  (Use RSTC_MR_Msk instead)  */
