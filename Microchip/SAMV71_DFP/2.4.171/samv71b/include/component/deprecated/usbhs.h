...
#ifndef _SAMV71_USBHS_COMPONENT_DEPRECATED_H_
#define _SAMV71_USBHS_COMPONENT_DEPRECATED_H_
...
#define USBHS_FSM_DRDSTATE_A_HOST DEPRECATED(USBHS_FSM_DRDSTATE_A_HOST, "Using deprecated macro USBHS_FSM_DRDSTATE_A_HOST") (USBHS_FSM_DRDSTATE_A_HOST_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the A-device that operates in Host mode is operational. Position */
#define USBHS_FSM_DRDSTATE_A_HOST_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_HOST_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_HOST_Val") _U_(0x3) /**< (USBHS_FSM) In this state, the A-device that operates in Host mode is operational. */
#define USBHS_FSM_DRDSTATE_A_IDLESTATE DEPRECATED(USBHS_FSM_DRDSTATE_A_IDLESTATE, "Using deprecated macro USBHS_FSM_DRDSTATE_A_IDLESTATE") (USBHS_FSM_DRDSTATE_A_IDLESTATE_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) This is the start state for A-devices (when the ID pin is 0) Position */
#define USBHS_FSM_DRDSTATE_A_IDLESTATE_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_IDLESTATE_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_IDLESTATE_Val") _U_(0x0) /**< (USBHS_FSM) This is the start state for A-devices (when the ID pin is 0) */
#define USBHS_FSM_DRDSTATE_A_PERIPHERAL DEPRECATED(USBHS_FSM_DRDSTATE_A_PERIPHERAL, "Using deprecated macro USBHS_FSM_DRDSTATE_A_PERIPHERAL") (USBHS_FSM_DRDSTATE_A_PERIPHERAL_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) The A-device operates as a peripheral. Position */
#define USBHS_FSM_DRDSTATE_A_PERIPHERAL_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_PERIPHERAL_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_PERIPHERAL_Val") _U_(0x5) /**< (USBHS_FSM) The A-device operates as a peripheral. */
#define USBHS_FSM_DRDSTATE_A_SUSPEND DEPRECATED(USBHS_FSM_DRDSTATE_A_SUSPEND, "Using deprecated macro USBHS_FSM_DRDSTATE_A_SUSPEND") (USBHS_FSM_DRDSTATE_A_SUSPEND_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) The A-device operating as a host is in the Suspend mode. Position */
#define USBHS_FSM_DRDSTATE_A_SUSPEND_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_SUSPEND_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_SUSPEND_Val") _U_(0x4) /**< (USBHS_FSM) The A-device operating as a host is in the Suspend mode. */
#define USBHS_FSM_DRDSTATE_A_VBUS_ERR DEPRECATED(USBHS_FSM_DRDSTATE_A_VBUS_ERR, "Using deprecated macro USBHS_FSM_DRDSTATE_A_VBUS_ERR") (USBHS_FSM_DRDSTATE_A_VBUS_ERR_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the A-device waits for recovery of the over-current condition that caused it to enter this state. Position */
#define USBHS_FSM_DRDSTATE_A_VBUS_ERR_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_VBUS_ERR_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_VBUS_ERR_Val") _U_(0x7) /**< (USBHS_FSM) In this state, the A-device waits for recovery of the over-current condition that caused it to enter this state. */
#define USBHS_FSM_DRDSTATE_A_WAIT_BCON DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_BCON, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_BCON") (USBHS_FSM_DRDSTATE_A_WAIT_BCON_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the A-device waits for the B-device to signal a connection. Position */
#define USBHS_FSM_DRDSTATE_A_WAIT_BCON_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_BCON_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_BCON_Val") _U_(0x2) /**< (USBHS_FSM) In this state, the A-device waits for the B-device to signal a connection. */
#define USBHS_FSM_DRDSTATE_A_WAIT_DISCHARGE DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_DISCHARGE, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_DISCHARGE") (USBHS_FSM_DRDSTATE_A_WAIT_DISCHARGE_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the A-device waits for the data USB line to discharge (100 us). Position */
#define USBHS_FSM_DRDSTATE_A_WAIT_DISCHARGE_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_DISCHARGE_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_DISCHARGE_Val") _U_(0x8) /**< (USBHS_FSM) In this state, the A-device waits for the data USB line to discharge (100 us). */
#define USBHS_FSM_DRDSTATE_A_WAIT_VFALL DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_VFALL, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_VFALL") (USBHS_FSM_DRDSTATE_A_WAIT_VFALL_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the A-device waits for the voltage on VBus to drop below the A-device Session Valid threshold (1.4 V). Position */
#define USBHS_FSM_DRDSTATE_A_WAIT_VFALL_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_VFALL_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_VFALL_Val") _U_(0x6) /**< (USBHS_FSM) In this state, the A-device waits for the voltage on VBus to drop below the A-device Session Valid threshold (1.4 V). */
#define USBHS_FSM_DRDSTATE_A_WAIT_VRISE DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_VRISE, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_VRISE") (USBHS_FSM_DRDSTATE_A_WAIT_VRISE_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the A-device waits for the voltage on VBus to rise above the A-device VBus Valid threshold (4.4 V). Position */
#define USBHS_FSM_DRDSTATE_A_WAIT_VRISE_Val DEPRECATED(USBHS_FSM_DRDSTATE_A_WAIT_VRISE_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_A_WAIT_VRISE_Val") _U_(0x1) /**< (USBHS_FSM) In this state, the A-device waits for the voltage on VBus to rise above the A-device VBus Valid threshold (4.4 V). */
#define USBHS_FSM_DRDSTATE_B_HOST DEPRECATED(USBHS_FSM_DRDSTATE_B_HOST, "Using deprecated macro USBHS_FSM_DRDSTATE_B_HOST") (USBHS_FSM_DRDSTATE_B_HOST_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the B-device acts as the Host. Position */
#define USBHS_FSM_DRDSTATE_B_HOST_Val DEPRECATED(USBHS_FSM_DRDSTATE_B_HOST_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_B_HOST_Val") _U_(0xE) /**< (USBHS_FSM) In this state, the B-device acts as the Host. */
#define USBHS_FSM_DRDSTATE_B_IDLE DEPRECATED(USBHS_FSM_DRDSTATE_B_IDLE, "Using deprecated macro USBHS_FSM_DRDSTATE_B_IDLE") (USBHS_FSM_DRDSTATE_B_IDLE_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) This is the start state for B-device (when the ID pin is 1). Position */
#define USBHS_FSM_DRDSTATE_B_IDLE_Val DEPRECATED(USBHS_FSM_DRDSTATE_B_IDLE_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_B_IDLE_Val") _U_(0x9) /**< (USBHS_FSM) This is the start state for B-device (when the ID pin is 1). */
#define USBHS_FSM_DRDSTATE_B_PERIPHERAL DEPRECATED(USBHS_FSM_DRDSTATE_B_PERIPHERAL, "Using deprecated macro USBHS_FSM_DRDSTATE_B_PERIPHERAL") (USBHS_FSM_DRDSTATE_B_PERIPHERAL_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the B-device acts as the peripheral. Position */
#define USBHS_FSM_DRDSTATE_B_PERIPHERAL_Val DEPRECATED(USBHS_FSM_DRDSTATE_B_PERIPHERAL_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_B_PERIPHERAL_Val") _U_(0xA) /**< (USBHS_FSM) In this state, the B-device acts as the peripheral. */
#define USBHS_FSM_DRDSTATE_B_SRP_INIT DEPRECATED(USBHS_FSM_DRDSTATE_B_SRP_INIT, "Using deprecated macro USBHS_FSM_DRDSTATE_B_SRP_INIT") (USBHS_FSM_DRDSTATE_B_SRP_INIT_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the B-device attempts to start a session using the SRP protocol. Position */
#define USBHS_FSM_DRDSTATE_B_SRP_INIT_Val DEPRECATED(USBHS_FSM_DRDSTATE_B_SRP_INIT_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_B_SRP_INIT_Val") _U_(0xF) /**< (USBHS_FSM) In this state, the B-device attempts to start a session using the SRP protocol. */
#define USBHS_FSM_DRDSTATE_B_WAIT_ACON DEPRECATED(USBHS_FSM_DRDSTATE_B_WAIT_ACON, "Using deprecated macro USBHS_FSM_DRDSTATE_B_WAIT_ACON") (USBHS_FSM_DRDSTATE_B_WAIT_ACON_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the B-device waits for the A-device to signal a connect before becoming B-Host. Position */
#define USBHS_FSM_DRDSTATE_B_WAIT_ACON_Val DEPRECATED(USBHS_FSM_DRDSTATE_B_WAIT_ACON_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_B_WAIT_ACON_Val") _U_(0xD) /**< (USBHS_FSM) In this state, the B-device waits for the A-device to signal a connect before becoming B-Host. */
#define USBHS_FSM_DRDSTATE_B_WAIT_BEGIN_HNP DEPRECATED(USBHS_FSM_DRDSTATE_B_WAIT_BEGIN_HNP, "Using deprecated macro USBHS_FSM_DRDSTATE_B_WAIT_BEGIN_HNP") (USBHS_FSM_DRDSTATE_B_WAIT_BEGIN_HNP_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the B-device is in Suspend mode and waits until 3 ms before initiating the HNP protocol if requested. Position */
#define USBHS_FSM_DRDSTATE_B_WAIT_BEGIN_HNP_Val DEPRECATED(USBHS_FSM_DRDSTATE_B_WAIT_BEGIN_HNP_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_B_WAIT_BEGIN_HNP_Val") _U_(0xB) /**< (USBHS_FSM) In this state, the B-device is in Suspend mode and waits until 3 ms before initiating the HNP protocol if requested. */
#define USBHS_FSM_DRDSTATE_B_WAIT_DISCHARGE DEPRECATED(USBHS_FSM_DRDSTATE_B_WAIT_DISCHARGE, "Using deprecated macro USBHS_FSM_DRDSTATE_B_WAIT_DISCHARGE") (USBHS_FSM_DRDSTATE_B_WAIT_DISCHARGE_Val << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) In this state, the B-device waits for the data USB line to discharge (100 us)) before becoming Host. Position */
#define USBHS_FSM_DRDSTATE_B_WAIT_DISCHARGE_Val DEPRECATED(USBHS_FSM_DRDSTATE_B_WAIT_DISCHARGE_Val, "Using deprecated macro USBHS_FSM_DRDSTATE_B_WAIT_DISCHARGE_Val") _U_(0xC) /**< (USBHS_FSM) In this state, the B-device waits for the data USB line to discharge (100 us)) before becoming Host. */
#define USBHS_FSM_DRDSTATE_Msk DEPRECATED(USBHS_FSM_DRDSTATE_Msk, "Using deprecated macro USBHS_FSM_DRDSTATE_Msk") (_U_(0xF) << USBHS_FSM_DRDSTATE_Pos) /**< (USBHS_FSM) Dual Role Device State Mask */
#define USBHS_FSM_DRDSTATE_Pos DEPRECATED(USBHS_FSM_DRDSTATE_Pos, "Using deprecated macro USBHS_FSM_DRDSTATE_Pos") 0 /**< (USBHS_FSM) Dual Role Device State Position */
#define USBHS_FSM_DRDSTATE(value) DEPRECATED(USBHS_FSM_DRDSTATE, "Using deprecated macro USBHS_FSM_DRDSTATE") (USBHS_FSM_DRDSTATE_Msk & ((value) << USBHS_FSM_DRDSTATE_Pos))
#define USBHS_FSM_MASK DEPRECATED(USBHS_FSM_MASK, "Using deprecated macro USBHS_FSM_MASK") _U_(0x0F) /**< \deprecated (USBHS_FSM) Register MASK (Use USBHS_FSM_Msk instead) */
#define USBHS_FSM_Msk DEPRECATED(USBHS_FSM_Msk, "Using deprecated macro USBHS_FSM_Msk") _U_(0x0F) /**< (USBHS_FSM) Register Mask */
#define USBHS_FSM_OFFSET DEPRECATED(USBHS_FSM_OFFSET, "Using deprecated macro USBHS_FSM_OFFSET") (0x82C) /**< (USBHS_FSM) General Finite State Machine Register Offset */
...
#define USBHS_TSTA1_CounterA_Msk DEPRECATED(USBHS_TSTA1_CounterA_Msk, "Using deprecated macro USBHS_TSTA1_CounterA_Msk") (_U_(0x7FFF) << USBHS_TSTA1_CounterA_Pos) /**< (USBHS_TSTA1) Counter A Mask */
#define USBHS_TSTA1_CounterA_Pos DEPRECATED(USBHS_TSTA1_CounterA_Pos, "Using deprecated macro USBHS_TSTA1_CounterA_Pos") 0 /**< (USBHS_TSTA1) Counter A Position */
#define USBHS_TSTA1_CounterA(value) DEPRECATED(USBHS_TSTA1_CounterA, "Using deprecated macro USBHS_TSTA1_CounterA") (USBHS_TSTA1_CounterA_Msk & ((value) << USBHS_TSTA1_CounterA_Pos))
#define USBHS_TSTA1_CounterB_Msk DEPRECATED(USBHS_TSTA1_CounterB_Msk, "Using deprecated macro USBHS_TSTA1_CounterB_Msk") (_U_(0x3F) << USBHS_TSTA1_CounterB_Pos) /**< (USBHS_TSTA1) Counter B Mask */
#define USBHS_TSTA1_CounterB_Pos DEPRECATED(USBHS_TSTA1_CounterB_Pos, "Using deprecated macro USBHS_TSTA1_CounterB_Pos") 16 /**< (USBHS_TSTA1) Counter B Position */
#define USBHS_TSTA1_CounterB(value) DEPRECATED(USBHS_TSTA1_CounterB, "Using deprecated macro USBHS_TSTA1_CounterB") (USBHS_TSTA1_CounterB_Msk & ((value) << USBHS_TSTA1_CounterB_Pos))
#define USBHS_TSTA1_LoadCntA_Msk DEPRECATED(USBHS_TSTA1_LoadCntA_Msk, "Using deprecated macro USBHS_TSTA1_LoadCntA_Msk") (_U_(0x1) << USBHS_TSTA1_LoadCntA_Pos) /**< (USBHS_TSTA1) Load CounterA Mask */
#define USBHS_TSTA1_LoadCntA_Pos DEPRECATED(USBHS_TSTA1_LoadCntA_Pos, "Using deprecated macro USBHS_TSTA1_LoadCntA_Pos") 15 /**< (USBHS_TSTA1) Load CounterA Position */
#define USBHS_TSTA1_LoadCntA DEPRECATED(USBHS_TSTA1_LoadCntA, "Using deprecated macro USBHS_TSTA1_LoadCntA") USBHS_TSTA1_LoadCntA_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA1_LoadCntA_Msk instead */
#define USBHS_TSTA1_LoadCntB_Msk DEPRECATED(USBHS_TSTA1_LoadCntB_Msk, "Using deprecated macro USBHS_TSTA1_LoadCntB_Msk") (_U_(0x1) << USBHS_TSTA1_LoadCntB_Pos) /**< (USBHS_TSTA1) Load CounterB Mask */
#define USBHS_TSTA1_LoadCntB_Pos DEPRECATED(USBHS_TSTA1_LoadCntB_Pos, "Using deprecated macro USBHS_TSTA1_LoadCntB_Pos") 23 /**< (USBHS_TSTA1) Load CounterB Position */
#define USBHS_TSTA1_LoadCntB DEPRECATED(USBHS_TSTA1_LoadCntB, "Using deprecated macro USBHS_TSTA1_LoadCntB") USBHS_TSTA1_LoadCntB_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA1_LoadCntB_Msk instead */
#define USBHS_TSTA1_LoadSOFCnt_Msk DEPRECATED(USBHS_TSTA1_LoadSOFCnt_Msk, "Using deprecated macro USBHS_TSTA1_LoadSOFCnt_Msk") (_U_(0x1) << USBHS_TSTA1_LoadSOFCnt_Pos) /**< (USBHS_TSTA1) Load SOF Counter Mask */
#define USBHS_TSTA1_LoadSOFCnt_Pos DEPRECATED(USBHS_TSTA1_LoadSOFCnt_Pos, "Using deprecated macro USBHS_TSTA1_LoadSOFCnt_Pos") 31 /**< (USBHS_TSTA1) Load SOF Counter Position */
#define USBHS_TSTA1_LoadSOFCnt DEPRECATED(USBHS_TSTA1_LoadSOFCnt, "Using deprecated macro USBHS_TSTA1_LoadSOFCnt") USBHS_TSTA1_LoadSOFCnt_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA1_LoadSOFCnt_Msk instead */
#define USBHS_TSTA1_MASK DEPRECATED(USBHS_TSTA1_MASK, "Using deprecated macro USBHS_TSTA1_MASK") _U_(0xFFBFFFFF) /**< \deprecated (USBHS_TSTA1) Register MASK (Use USBHS_TSTA1_Msk instead) */
#define USBHS_TSTA1_Msk DEPRECATED(USBHS_TSTA1_Msk, "Using deprecated macro USBHS_TSTA1_Msk") _U_(0xFFBFFFFF) /**< (USBHS_TSTA1) Register Mask */
#define USBHS_TSTA1_OFFSET DEPRECATED(USBHS_TSTA1_OFFSET, "Using deprecated macro USBHS_TSTA1_OFFSET") (0x810) /**< (USBHS_TSTA1) General Test A1 Register Offset */
#define USBHS_TSTA1_SOFCntMa1_Msk DEPRECATED(USBHS_TSTA1_SOFCntMa1_Msk, "Using deprecated macro USBHS_TSTA1_SOFCntMa1_Msk") (_U_(0x7F) << USBHS_TSTA1_SOFCntMa1_Pos) /**< (USBHS_TSTA1) SOF Counter Max Mask */
#define USBHS_TSTA1_SOFCntMa1_Pos DEPRECATED(USBHS_TSTA1_SOFCntMa1_Pos, "Using deprecated macro USBHS_TSTA1_SOFCntMa1_Pos") 24 /**< (USBHS_TSTA1) SOF Counter Max Position */
#define USBHS_TSTA1_SOFCntMa1(value) DEPRECATED(USBHS_TSTA1_SOFCntMa1, "Using deprecated macro USBHS_TSTA1_SOFCntMa1") (USBHS_TSTA1_SOFCntMa1_Msk & ((value) << USBHS_TSTA1_SOFCntMa1_Pos))
#define USBHS_TSTA2_ByPassDpll_Msk DEPRECATED(USBHS_TSTA2_ByPassDpll_Msk, "Using deprecated macro USBHS_TSTA2_ByPassDpll_Msk") (_U_(0x1) << USBHS_TSTA2_ByPassDpll_Pos) /**< (USBHS_TSTA2) Bypass DPLL Mask */
#define USBHS_TSTA2_ByPassDpll_Pos DEPRECATED(USBHS_TSTA2_ByPassDpll_Pos, "Using deprecated macro USBHS_TSTA2_ByPassDpll_Pos") 5 /**< (USBHS_TSTA2) Bypass DPLL Position */
#define USBHS_TSTA2_ByPassDpll DEPRECATED(USBHS_TSTA2_ByPassDpll, "Using deprecated macro USBHS_TSTA2_ByPassDpll") USBHS_TSTA2_ByPassDpll_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_ByPassDpll_Msk instead */
#define USBHS_TSTA2_DisableGatedClock_Msk DEPRECATED(USBHS_TSTA2_DisableGatedClock_Msk, "Using deprecated macro USBHS_TSTA2_DisableGatedClock_Msk") (_U_(0x1) << USBHS_TSTA2_DisableGatedClock_Pos) /**< (USBHS_TSTA2) Disable Gated Clock Mask */
#define USBHS_TSTA2_DisableGatedClock_Pos DEPRECATED(USBHS_TSTA2_DisableGatedClock_Pos, "Using deprecated macro USBHS_TSTA2_DisableGatedClock_Pos") 3 /**< (USBHS_TSTA2) Disable Gated Clock Position */
#define USBHS_TSTA2_DisableGatedClock DEPRECATED(USBHS_TSTA2_DisableGatedClock, "Using deprecated macro USBHS_TSTA2_DisableGatedClock") USBHS_TSTA2_DisableGatedClock_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_DisableGatedClock_Msk instead */
#define USBHS_TSTA2_ForceHSRst_50ms_Msk DEPRECATED(USBHS_TSTA2_ForceHSRst_50ms_Msk, "Using deprecated macro USBHS_TSTA2_ForceHSRst_50ms_Msk") (_U_(0x1) << USBHS_TSTA2_ForceHSRst_50ms_Pos) /**< (USBHS_TSTA2) Force HS Reset to 50 ms Mask */
#define USBHS_TSTA2_ForceHSRst_50ms_Pos DEPRECATED(USBHS_TSTA2_ForceHSRst_50ms_Pos, "Using deprecated macro USBHS_TSTA2_ForceHSRst_50ms_Pos") 7 /**< (USBHS_TSTA2) Force HS Reset to 50 ms Position */
#define USBHS_TSTA2_ForceHSRst_50ms DEPRECATED(USBHS_TSTA2_ForceHSRst_50ms, "Using deprecated macro USBHS_TSTA2_ForceHSRst_50ms") USBHS_TSTA2_ForceHSRst_50ms_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_ForceHSRst_50ms_Msk instead */
#define USBHS_TSTA2_ForceSuspendMTo1_Msk DEPRECATED(USBHS_TSTA2_ForceSuspendMTo1_Msk, "Using deprecated macro USBHS_TSTA2_ForceSuspendMTo1_Msk") (_U_(0x1) << USBHS_TSTA2_ForceSuspendMTo1_Pos) /**< (USBHS_TSTA2) Force SuspendM to 1 Mask */
#define USBHS_TSTA2_ForceSuspendMTo1_Pos DEPRECATED(USBHS_TSTA2_ForceSuspendMTo1_Pos, "Using deprecated macro USBHS_TSTA2_ForceSuspendMTo1_Pos") 4 /**< (USBHS_TSTA2) Force SuspendM to 1 Position */
#define USBHS_TSTA2_ForceSuspendMTo1 DEPRECATED(USBHS_TSTA2_ForceSuspendMTo1, "Using deprecated macro USBHS_TSTA2_ForceSuspendMTo1") USBHS_TSTA2_ForceSuspendMTo1_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_ForceSuspendMTo1_Msk instead */
#define USBHS_TSTA2_FullDetachEn_Msk DEPRECATED(USBHS_TSTA2_FullDetachEn_Msk, "Using deprecated macro USBHS_TSTA2_FullDetachEn_Msk") (_U_(0x1) << USBHS_TSTA2_FullDetachEn_Pos) /**< (USBHS_TSTA2) Full Detach Enable Mask */
#define USBHS_TSTA2_FullDetachEn_Pos DEPRECATED(USBHS_TSTA2_FullDetachEn_Pos, "Using deprecated macro USBHS_TSTA2_FullDetachEn_Pos") 0 /**< (USBHS_TSTA2) Full Detach Enable Position */
#define USBHS_TSTA2_FullDetachEn DEPRECATED(USBHS_TSTA2_FullDetachEn, "Using deprecated macro USBHS_TSTA2_FullDetachEn") USBHS_TSTA2_FullDetachEn_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_FullDetachEn_Msk instead */
#define USBHS_TSTA2_HostHSDisconnectDisable_Msk DEPRECATED(USBHS_TSTA2_HostHSDisconnectDisable_Msk, "Using deprecated macro USBHS_TSTA2_HostHSDisconnectDisable_Msk") (_U_(0x1) << USBHS_TSTA2_HostHSDisconnectDisable_Pos) /**< (USBHS_TSTA2) Host HS Disconnect Disable Mask */
#define USBHS_TSTA2_HostHSDisconnectDisable_Pos DEPRECATED(USBHS_TSTA2_HostHSDisconnectDisable_Pos, "Using deprecated macro USBHS_TSTA2_HostHSDisconnectDisable_Pos") 6 /**< (USBHS_TSTA2) Host HS Disconnect Disable Position */
#define USBHS_TSTA2_HostHSDisconnectDisable DEPRECATED(USBHS_TSTA2_HostHSDisconnectDisable, "Using deprecated macro USBHS_TSTA2_HostHSDisconnectDisable") USBHS_TSTA2_HostHSDisconnectDisable_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_HostHSDisconnectDisable_Msk instead */
#define USBHS_TSTA2_HSSerialMode_Msk DEPRECATED(USBHS_TSTA2_HSSerialMode_Msk, "Using deprecated macro USBHS_TSTA2_HSSerialMode_Msk") (_U_(0x1) << USBHS_TSTA2_HSSerialMode_Pos) /**< (USBHS_TSTA2) HS Serial Mode Mask */
#define USBHS_TSTA2_HSSerialMode_Pos DEPRECATED(USBHS_TSTA2_HSSerialMode_Pos, "Using deprecated macro USBHS_TSTA2_HSSerialMode_Pos") 1 /**< (USBHS_TSTA2) HS Serial Mode Position */
#define USBHS_TSTA2_HSSerialMode DEPRECATED(USBHS_TSTA2_HSSerialMode, "Using deprecated macro USBHS_TSTA2_HSSerialMode") USBHS_TSTA2_HSSerialMode_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_HSSerialMode_Msk instead */
#define USBHS_TSTA2_LoopBackMode_Msk DEPRECATED(USBHS_TSTA2_LoopBackMode_Msk, "Using deprecated macro USBHS_TSTA2_LoopBackMode_Msk") (_U_(0x1) << USBHS_TSTA2_LoopBackMode_Pos) /**< (USBHS_TSTA2) Loop-back Mode Mask */
#define USBHS_TSTA2_LoopBackMode_Pos DEPRECATED(USBHS_TSTA2_LoopBackMode_Pos, "Using deprecated macro USBHS_TSTA2_LoopBackMode_Pos") 2 /**< (USBHS_TSTA2) Loop-back Mode Position */
#define USBHS_TSTA2_LoopBackMode DEPRECATED(USBHS_TSTA2_LoopBackMode, "Using deprecated macro USBHS_TSTA2_LoopBackMode") USBHS_TSTA2_LoopBackMode_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_LoopBackMode_Msk instead */
#define USBHS_TSTA2_MASK DEPRECATED(USBHS_TSTA2_MASK, "Using deprecated macro USBHS_TSTA2_MASK") _U_(0x2FF) /**< \deprecated (USBHS_TSTA2) Register MASK (Use USBHS_TSTA2_Msk instead) */
#define USBHS_TSTA2_Msk DEPRECATED(USBHS_TSTA2_Msk, "Using deprecated macro USBHS_TSTA2_Msk") _U_(0x2FF) /**< (USBHS_TSTA2) Register Mask */
#define USBHS_TSTA2_OFFSET DEPRECATED(USBHS_TSTA2_OFFSET, "Using deprecated macro USBHS_TSTA2_OFFSET") (0x814) /**< (USBHS_TSTA2) General Test A2 Register Offset */
#define USBHS_TSTA2_RemovePUWhenTX_Msk DEPRECATED(USBHS_TSTA2_RemovePUWhenTX_Msk, "Using deprecated macro USBHS_TSTA2_RemovePUWhenTX_Msk") (_U_(0x1) << USBHS_TSTA2_RemovePUWhenTX_Pos) /**< (USBHS_TSTA2) Remove Pull-up When TX Mask */
#define USBHS_TSTA2_RemovePUWhenTX_Pos DEPRECATED(USBHS_TSTA2_RemovePUWhenTX_Pos, "Using deprecated macro USBHS_TSTA2_RemovePUWhenTX_Pos") 9 /**< (USBHS_TSTA2) Remove Pull-up When TX Position */
#define USBHS_TSTA2_RemovePUWhenTX DEPRECATED(USBHS_TSTA2_RemovePUWhenTX, "Using deprecated macro USBHS_TSTA2_RemovePUWhenTX") USBHS_TSTA2_RemovePUWhenTX_Msk /**< \deprecated Old style mask definition for 1 bit bitfield. Use USBHS_TSTA2_RemovePUWhenTX_Msk instead */
#define USBHS_VERSION_MASK DEPRECATED(USBHS_VERSION_MASK, "Using deprecated macro USBHS_VERSION_MASK") _U_(0xF0FFF) /**< \deprecated (USBHS_VERSION) Register MASK (Use USBHS_VERSION_Msk instead) */
#define USBHS_VERSION_MFN_Msk DEPRECATED(USBHS_VERSION_MFN_Msk, "Using deprecated macro USBHS_VERSION_MFN_Msk") (_U_(0xF) << USBHS_VERSION_MFN_Pos) /**< (USBHS_VERSION) Metal Fix Number Mask */
#define USBHS_VERSION_MFN_Pos DEPRECATED(USBHS_VERSION_MFN_Pos, "Using deprecated macro USBHS_VERSION_MFN_Pos") 16 /**< (USBHS_VERSION) Metal Fix Number Position */
#define USBHS_VERSION_MFN(value) DEPRECATED(USBHS_VERSION_MFN, "Using deprecated macro USBHS_VERSION_MFN") (USBHS_VERSION_MFN_Msk & ((value) << USBHS_VERSION_MFN_Pos))
#define USBHS_VERSION_Msk DEPRECATED(USBHS_VERSION_Msk, "Using deprecated macro USBHS_VERSION_Msk") _U_(0xF0FFF) /**< (USBHS_VERSION) Register Mask */
#define USBHS_VERSION_OFFSET DEPRECATED(USBHS_VERSION_OFFSET, "Using deprecated macro USBHS_VERSION_OFFSET") (0x818) /**< (USBHS_VERSION) General Version Register Offset */
#define USBHS_VERSION_VERSION_Msk DEPRECATED(USBHS_VERSION_VERSION_Msk, "Using deprecated macro USBHS_VERSION_VERSION_Msk") (_U_(0xFFF) << USBHS_VERSION_VERSION_Pos) /**< (USBHS_VERSION) Version Number Mask */
#define USBHS_VERSION_VERSION_Pos DEPRECATED(USBHS_VERSION_VERSION_Pos, "Using deprecated macro USBHS_VERSION_VERSION_Pos") 0 /**< (USBHS_VERSION) Version Number Position */
#define USBHS_VERSION_VERSION(value) DEPRECATED(USBHS_VERSION_VERSION, "Using deprecated macro USBHS_VERSION_VERSION") (USBHS_VERSION_VERSION_Msk & ((value) << USBHS_VERSION_VERSION_Pos))
