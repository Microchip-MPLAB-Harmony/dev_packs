 ...
 * $Revision:    V1.00
 *
 * Project:      Flash Device Description for ATSAMS7x
 * --------------------------------------------------------------------------- */
...
struct FlashDevice const FlashDevice  =  {
   ...
   "ATSAMS7x 512kB Flash",      // Device Name
   ONCHIP,                      // Device Type
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMS7x 1024kB Flash",     // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
...
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMS7x 2048kB Flash",     // Device Name
   ONCHIP,                      // Device Type
   0x00400000,                  // Device Start Address
...
#ifdef FLASH_GPNVM
#if defined ATSAMS7x_2048
struct FlashDevice const FlashDevice  =  {
   FLASH_DRV_VERS,              // Driver Version, do not modify!
   "ATSAMS7x GPNVM bits",       // Device Name
   ONCHIP,                      // Device Type
