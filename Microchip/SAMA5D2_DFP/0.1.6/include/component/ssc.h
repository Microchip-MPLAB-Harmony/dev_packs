...
#define _SAMA5D2_SSC_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Synchronous Serial Controller
 *  @{
 */
/* ========================================================================== */
...
#define REV_SSC R                      /**< (SSC) Module revision */
