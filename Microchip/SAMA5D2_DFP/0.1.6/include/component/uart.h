...
#define _SAMA5D2_UART_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 Universal Asynchronous Receiver Transmitter
 *  @{
 */
/* ========================================================================== */
...
typedef union { 
  struct {
    ...
    uint32_t RETTO:1;                   /**< bit:     10  Rearm Time-out                           */
...
#define UART_CR_RETTO_Pos                   10                                             /**< (UART_CR) Rearm Time-out Position */
#define UART_CR_RETTO_Msk                   (_U_(0x1) << UART_CR_RETTO_Pos)                /**< (UART_CR) Rearm Time-out Mask */
#define UART_CR_RETTO                       UART_CR_RETTO_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use UART_CR_RETTO_Msk instead */
#define UART_CR_STTTO_Pos                   11                                             /**< (UART_CR) Start Time-out Position */
#define UART_CR_STTTO_Msk                   (_U_(0x1) << UART_CR_STTTO_Pos)                /**< (UART_CR) Start Time-out Mask */
#define UART_CR_STTTO                       UART_CR_STTTO_Msk                              /**< \deprecated Old style mask definition for 1 bit bitfield. Use UART_CR_STTTO_Msk instead */
...
#define UART_CR_MASK                        _U_(0x9DFC)                                    /**< \deprecated (UART_CR) Register MASK  (Use UART_CR_Msk instead)  */
#define UART_CR_Msk                         _U_(0x9DFC)                                    /**< (UART_CR) Register Mask  */
...
typedef union { 
  struct {
    ...
    uint32_t TIMEOUT:1;                 /**< bit:      8  Enable Time-out Interrupt                */
...
#define UART_IER_TIMEOUT_Pos                8                                              /**< (UART_IER) Enable Time-out Interrupt Position */
#define UART_IER_TIMEOUT_Msk                (_U_(0x1) << UART_IER_TIMEOUT_Pos)             /**< (UART_IER) Enable Time-out Interrupt Mask */
#define UART_IER_TIMEOUT                    UART_IER_TIMEOUT_Msk                           /**< \deprecated Old style mask definition for 1 bit bitfield. Use UART_IER_TIMEOUT_Msk instead */
...
#define UART_IER_MASK                       _U_(0x83E3)                                    /**< \deprecated (UART_IER) Register MASK  (Use UART_IER_Msk instead)  */
#define UART_IER_Msk                        _U_(0x83E3)                                    /**< (UART_IER) Register Mask  */
...
typedef union { 
  struct {
    ...
    uint32_t TIMEOUT:1;                 /**< bit:      8  Disable Time-out Interrupt               */
...
#define UART_IDR_TIMEOUT_Pos                8                                              /**< (UART_IDR) Disable Time-out Interrupt Position */
#define UART_IDR_TIMEOUT_Msk                (_U_(0x1) << UART_IDR_TIMEOUT_Pos)             /**< (UART_IDR) Disable Time-out Interrupt Mask */
#define UART_IDR_TIMEOUT                    UART_IDR_TIMEOUT_Msk                           /**< \deprecated Old style mask definition for 1 bit bitfield. Use UART_IDR_TIMEOUT_Msk instead */
...
#define UART_IDR_MASK                       _U_(0x83E3)                                    /**< \deprecated (UART_IDR) Register MASK  (Use UART_IDR_Msk instead)  */
#define UART_IDR_Msk                        _U_(0x83E3)                                    /**< (UART_IDR) Register Mask  */
...
typedef union { 
  struct {
    ...
    uint32_t TIMEOUT:1;                 /**< bit:      8  Mask Time-out Interrupt                  */
...
#define UART_IMR_TIMEOUT_Pos                8                                              /**< (UART_IMR) Mask Time-out Interrupt Position */
#define UART_IMR_TIMEOUT_Msk                (_U_(0x1) << UART_IMR_TIMEOUT_Pos)             /**< (UART_IMR) Mask Time-out Interrupt Mask */
#define UART_IMR_TIMEOUT                    UART_IMR_TIMEOUT_Msk                           /**< \deprecated Old style mask definition for 1 bit bitfield. Use UART_IMR_TIMEOUT_Msk instead */
...
#define UART_IMR_MASK                       _U_(0x83E3)                                    /**< \deprecated (UART_IMR) Register MASK  (Use UART_IMR_Msk instead)  */
#define UART_IMR_Msk                        _U_(0x83E3)                                    /**< (UART_IMR) Register Mask  */
...
#define UART_SR_TIMEOUT_Pos                 8                                              /**< (UART_SR) Receiver Time-out Position */
#define UART_SR_TIMEOUT_Msk                 (_U_(0x1) << UART_SR_TIMEOUT_Pos)              /**< (UART_SR) Receiver Time-out Mask */
#define UART_SR_TIMEOUT                     UART_SR_TIMEOUT_Msk                            /**< \deprecated Old style mask definition for 1 bit bitfield. Use UART_SR_TIMEOUT_Msk instead */
...
#define UART_SR_MASK                        _U_(0xE083E3)                                  /**< \deprecated (UART_SR) Register MASK  (Use UART_SR_Msk instead)  */
#define UART_SR_Msk                         _U_(0xE083E3)                                  /**< (UART_SR) Register Mask  */
...
typedef union { 
  struct {
    uint32_t TO:8;                      /**< bit:   0..7  Time-out Value                           */
    uint32_t :24;                       /**< bit:  8..31  Reserved */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} UART_RTOR_Type;
...
#define UART_RTOR_OFFSET                    (0x28)                                        /**<  (UART_RTOR) Receiver Time-out Register  Offset */

#define UART_RTOR_TO_Pos                    0                                              /**< (UART_RTOR) Time-out Value Position */
...
#define UART_RTOR_MASK                      _U_(0xFF)                                      /**< \deprecated (UART_RTOR) Register MASK  (Use UART_RTOR_Msk instead)  */
#define UART_RTOR_Msk                       _U_(0xFF)                                      /**< (UART_RTOR) Register Mask  */
...
typedef struct {  
  ...
  __IO uint32_t UART_RTOR;      /**< (UART Offset: 0x28) Receiver Time-out Register */
  __I  uint8_t                        Reserved1[184];
...
typedef struct {  
  ...
  __IO UART_RTOR_Type                 UART_RTOR;      /**< Offset: 0x28 (R/W  32) Receiver Time-out Register */
  __I  uint8_t                        Reserved1[184];
