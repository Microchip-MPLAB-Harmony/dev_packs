 ...
 * \file
 *
 * \brief GCC startup file for ATSAM9X75D1G
 *
...
void DSI_Handler          ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
void MIPIPHY_Handler      ( void ) __attribute__ ((weak, alias("Dummy_Handler")));
...
const DeviceVectors exception_table = {
        ...
        .pfnCSI_Handler                = (void*) CSI_Handler,    /* 53 CSI Host Controller */
        .pfnDSI_Handler                = (void*) DSI_Handler,    /* 54 LCD Controller */
        .pfnMIPIPHY_Handler            = (void*) MIPIPHY_Handler, /* 55  */
