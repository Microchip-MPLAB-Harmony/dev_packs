...
#define _SAMA5D2_TRNG_COMPONENT_         /**< \deprecated  Backward compatibility for ASF */

/** \addtogroup SAMA5D2_SAMA5D2 True Random Number Generator
 *  @{
 */
/* ========================================================================== */
...
#define REV_TRNG K                      /**< (TRNG) Module revision */
...
typedef union { 
  struct {
    ...
    uint32_t WAKEY:24;                  /**< bit:  8..31  Register Write Access Key                */
...
#define TRNG_CR_WAKEY_Pos                   8                                              /**< (TRNG_CR) Register Write Access Key Position */
...
typedef union { 
  struct {
    uint32_t DATRDY:1;                  /**< bit:      0  Data Ready (cleared on read)             */
    uint32_t :31;                       /**< bit:  1..31  Reserved */
  } bit;                                /**< Structure used for bit  access */
  uint32_t reg;                         /**< Type used for register access */
} TRNG_ISR_Type;
...
#define TRNG_ISR_DATRDY_Pos                 0                                              /**< (TRNG_ISR) Data Ready (cleared on read) Position */
